...
status: register ruled on by Bill 2026-09-22 (anchors and kinds agreed; frame change in §2); the not-verified items in §6 are still owed; nothing cut to lookups/ yet
---
...
| gov.policy--data-governance-policy | I | AU | DPF | Six sections; "multi-prong strategy"; five implementation phases from Member-State adoption to intra-African collaboration | rungs | — |
...
| gov.legislate--e-commerce-legislation | I | AU | Malabo ch. I; AfCFTA DTP Arts 12, 16, 27 | Malabo Arts 2–5 free exercise, contracts, advertising; DTP Art. 16 legal framework for electronic transactions; Art. 27 consumer protection | top | UNCTAD Cyberlaw Tracker (four areas); UNCITRAL Model Law (1996) |
...
| gov.protect--national-data-protection-readiness | I | AU | DPF; AUC/ISOC Guidelines (2018); Malabo | DPF five phases; Guidelines' 18 recommendations; Malabo Arts 13–23 | rungs | Convention 108+ accession |
...
| gov.regional--cross-border-data-transfers | I | AU | Malabo Art. 14; DPF; AfCFTA DTP Art. 20 and Annex | Adequacy-based transfers; DPF regional flow mechanism; DTP Art. 20 allow transfer subject to the Annex | top | OECD Privacy Guidelines (2013) |
...
| gov.standards--national-quality-standards | I | AU | PAQI / CAMI-20 Declaration (2013) | PAQI as the continental platform for standardisation, metrology, accreditation | top | UNIDO Quality Policy Guiding Principles (2018); ISO 8000 / ISO/IEC 25012 for data quality |
| gov.standards--adoption-of-international-standards | I | AU | DTS; AU Interop. Framework; ARSO | Technology neutrality; framework "in line with international norms"; ARSO harmonised standards | top | WTO TBT Art. 2.4; ISO membership class as rungs |
...
- `gov.legislate--access-to-information-legislation` — The Model Law's clauses are the rungs; Model Law URL not fetched in this pass
...
- `gov.regional--cross-border-data-transfers` — Malabo paragraph number not verified; draft AU Cross-Border Data Flow Framework validated Dec 2025
- `gov.standards--national-interoperability-standards` — No AU instrument requires a national e-GIF
- `gov.standards--national-quality-standards` — Weak anchor: no Member-State obligation text verified
- `gov.standards--adoption-of-international-standards` — ARSO provision text not verified
...
- `finance.budget--financial-sustainability-of-digital-systems` — replaces `finance.mou--strategic-relationships`, which leaves the assessment (Bill, 2026-09-22: no norm on MoUs as such at any tier, and a relationship is not a position). The value is the domestic-state share of digital expenditure with recurrent costs separated, from the budget extract; a country with only migrated placeholder rows in `budgets/` is unassessed until its country-year is read. Proposed under `finance.budget` because the subject label already covers expenditure and the evidence is the budget file; a new `finance.sustain` subject would need an OSINT taxonomy change and is the alternative
...
| dpi.id--digital-id-from-birth | S | AU | DTS; CAMCR 2022 | Legal identity "as part of a civil registration process"; 100 % birth registration by 2030 (as reported) | target | UN Handbook on CRVS and Identity Management (2022) para 29 |
| dpi.id--interoperability-of-birth-registration-and-digital-id | S | AU | AU Interop. Framework §2.2; CAMCR 2019 | Builds on APAI-CRVS; ministers agreed on interoperability | top | UN Handbook 2022 para 23 |
...
| dpi.registry--land-register | S | AU | AU Declaration on Land (2009); Framework and Guidelines on Land Policy | No explicit registration paragraph (verified); DTS names a "Land Use register" | top | UN-GGIM FELA (2020); ISO 19152 LADM |
...
- `dpi.id--digital-id-from-birth` — CAMCR-6 declaration text not verified
- `dpi.id--interoperability-of-birth-registration-and-digital-id` — Declaration paragraph not verified
...
- `dpi.registry--land-register` — Weak anchor; F&G provisions not read
...
| tech.industry--national-capacity-in-dt-related-production | M | AU | DTS Digital Industry pillar; STISA-2034 | Assembly and manufacturing plants; device ≤ USD 100 made in Africa; ≥ 30 % of content developed and hosted in Africa; STISA R&D 1–2 % GDP | target | UNIDO CIP index; UNCTAD Digital Economy Report |
...
- `tech.industry--national-capacity-in-dt-related-production` — STISA figure from an AUDA-NEPAD summary, not the primary text
...
| capacity.research--think-tanks-and-academic-departments-contributing-to-dt-policy | I | AU | STISA-2034; Agenda 2063 STYIP | R&D ≥ 1 % of GDP; 10 % of global research output by 2033 | target (proxy) | UIS R&D; On Think Tanks directory |
...
- `data.satellite--agricultural-use-of-satellite-data` — DAS adopting organ not verified
...
- **Digital Transformation Strategy for Africa 2020–2030 (DTS)** — endorsed by STC-CICT-3 Oct 2019 and the Executive Council, EX.CL/Dec.1074(XXXVI) para 12, Feb 2020; published 18 May 2020. Non-binding strategy. Verified targets: universal access ≥ 6 Mb/s at ≤ 1 US cent/MB and a device ≤ USD 100 by 2030; ≥ 30 % of content developed and hosted in Africa; 99.9 % digital legal identity as part of civil registration by 2030; e-skills 100 m/yr by 2021 and 300 m/yr by 2025; ≥ 2 international connections per Member State; Malabo in force by 2020 (missed: 2023). https://au.int/sites/default/files/documents/38507-doc-DTS_for_Africa_2020-2030_English.pdf ; decision text https://au.int/sites/default/files/decisions/38181-ex_cl_dec_1073_-_1096_xxxvi_e.pdf
- **Agenda 2063 Second Ten-Year Implementation Plan 2024–2033 (STYIP)** — AU Assembly 37th Ordinary Session, Feb 2024 (decision number not verified). Seven Moonshots; 2033 targets: 80 % of population at ≥ 6 Mb/s; 80 % of households with electricity; 40 % of graduates in STEM; TVET enrolment + 60 %; tertiary NER 50 %; 10 % of global research output; 80 % of primary completers digitally proficient. https://www.nepad.org/publication/agenda-2063-second-ten-year-implementation-plan-2024-2033 (PDF mirrored at https://www.un.org/osaa/sites/www.un.org.osaa/files/43517-wd-agenda_2063_styip_feb_2024_launch_version.pdf). Goal 20 financing ratios are from the First Ten-Year Plan (Assembly/AU/Dec.565(XXIV), 2015): https://au.int/sites/default/files/documents/33126-doc-11_an_overview_of_agenda.pdf
- **AU Convention on Cyber Security and Personal Data Protection (Malabo)** — Assembly, 27 Jun 2014; in force 8 Jun 2023; 16 ratifications as of Jul 2024 (secondary sources vary 15–16). Chapter I e-transactions (Arts 1–7), Chapter II personal data (Arts 8–23; Art. 11 independent DPA; Art. 14 transfers), Chapter III cybersecurity (Arts 24–31). Article numbers from the dig.watch reproduction; the AU PDF is not machine-readable. https://au.int/en/treaties/african-union-convention-cyber-security-and-personal-data-protection
- **AU Data Policy Framework (DPF)** — Executive Council EX.CL/Dec.1144(XL), 2–3 Feb 2022; published 28 Jul 2022. Non-binding; six sections; five implementation phases; §5.3.1 foundational data infrastructure. https://au.int/sites/default/files/documents/42078-doc-DATA-POLICY-FRAMEWORKS-2024-ENG-V2.pdf
- **AU Interoperability Framework for Digital ID** — approved Feb 2022 (STC-CICT, per the African Digital Compact; organ decision not verified); published 11 Dec 2023. Ten principles (§3.1), three-layer architecture (§3.2), trust framework and Levels of Assurance (§3.3), Member-State commitments (§4.1), three phases. https://au.int/sites/default/files/documents/43393-doc-AU_Interoperability_framework_for_D_ID_English.pdf
- **Continental Artificial Intelligence Strategy** — 2nd Extraordinary STC-CICT Jun 2024; Executive Council 45th Ordinary Session, Accra, 18–19 Jul 2024 (decision number not verified). Five focus areas, fifteen action areas; Phase 1 2025–2026, Phase 2 from 2028. https://au.int/sites/default/files/documents/44004-doc-EN-_Continental_AI_Strategy_July_2024.pdf
- **African Digital Compact** — STC-CICT Jun 2024; published Jul 2024 (adoption decision not verified). No numeric targets. https://au.int/sites/default/files/documents/44005-doc-EN_African_Digital_Compact_-_July_2024.pdf
- **AfCFTA Protocol on Digital Trade (DTP)** — Assembly 37th Ordinary Session, Feb 2024; eight annexes adopted 38th Ordinary Session, 15–16 Feb 2025. Binding once in force; ratification status not verified. Article numbers as in the Feb 2024 text: 8–9 e-documents and e-authentication, 12 e-contracts, 13 e-invoicing, 14 digital ID, 15 digital payments, 16 e-transactions framework, 19 mutual recognition, 20 cross-border data, 22 computing facilities, 25 cybersecurity, 27 consumer protection, 38 transparency, 43 cooperation. Earlier drafts number differently. https://au.int/sites/default/files/treaties/45079-treaty-EN_AfCFTA_Protocol_on_Digital_Trade.pdf ; annex summaries https://www.tralac.org/documents/events/tralac/5918-2025-conference-two-pager-summary-of-the-annexes-to-the-afcfta-protocol-on-digital-trade/file.html
...
- **ACHPR Model Law on Access to Information for Africa** — ACHPR, 2013. Clause-level checklist. URL not fetched in this pass.
...
- **African Charter on Democracy, Elections and Governance (ACDEG)** — Assembly 30 Jan 2007; in force 15 Feb 2012; 34 ratifications (2019 figure). Arts 2, 3, 12, 17, 27, 28, 30, 31. https://au.int/en/treaties/african-charter-democracy-elections-and-governance
...
- **Protocol to the ACHPR on the Rights of Persons with Disabilities in Africa** — Assembly Jan 2018; in force May 2024 (15 ratifications). Arts 23, 24. https://au.int/en/treaties/protocol-african-charter-human-and-peoples-rights-rights-persons-disabilities-africa
...
- **AU Digital Education Strategy and Implementation Plan (DES, 2023–2028)** — AUC-ESTI, Sep 2022 (adopting organ not verified; EU-funded). Device, connectivity and NREN targets 2027/2030; EMIS 2.0; five maturity categories of Member States. https://au.int/sites/default/files/documents/42416-doc-1._DES_EN_-_2022_09_14.pdf
- **Continental Education Strategy for Africa 2026–2035 (CESA 26-35)** — AU, published Jun 2025 (Assembly decision not verified). No numeric targets. https://au.int/sites/default/files/documents/44940-doc-AU_CESA-2026-2035_Strategy_ENGLISH.pdf
- **Continental Strategy for TVET** — AU, 2018; re-issued Feb 2024. Content not extracted. https://au.int/en/documents/20240212/continental-strategy-technical-and-vocational-education-and-training-tvet-foster
- **STISA-2034** — STC-EST-5 ministers Nov 2024; launched 39th Assembly Feb 2026 (organ decision not located). R&D 1–2 % of GDP benchmark from an AUDA-NEPAD summary. https://www.nepad.org/publication/science-technology-and-innovation-strategy-africa-stisa-2034
- **AU Digital Agriculture Strategy 2024–2030** — AUC-ARBE, 2024 (adopting organ not verified). https://au.int/sites/default/files/documents/43481-doc-DAS_EN.pdf
...
- **CAMI-20 Declaration on quality infrastructure / PAQI** — Conference of Ministers of Industry, Jun 2013; PAQI launched Aug 2013. Member-State obligation text not verified. https://www.paqi.org/
...
- **PIDA Priority Action Plan 2 (2021–2030)** — Assembly 34th Ordinary Session, Feb 2021 (decision not verified); prospectus 2023. https://www.au-pida.org/wp-content/uploads/2023/09/EN-NEPAD-PIDA-PAP2-Project-Prospectus-Web-1-92_81-81.pdf
...
- **ATU-R Recommendation 005-0** — African Telecommunications Union, Jul 2021. https://atuuat.africa/wp-content/uploads/2021/08/En_ATU-R-Recommendation-005-0.pdf
- **APAI-CRVS and the Conference of African Ministers responsible for Civil Registration** — AUC/UNECA/AfDB programme; CRVS Decade 2017–2026; 5th conference Lusaka Oct 2019, 6th Addis Ababa Oct 2022 (declaration texts not read). https://apai-crvs.uneca.org/ ; https://au.int/en/ea/keyevents/camcr
...
Everything below was flagged *not verified* by the research pass and is to be confirmed against the primary text before `lookups/maturity-norms.csv` carries it as fact.

- Executive Council or Assembly decision numbers for: DTS (given as EX.CL/Dec.1074(XXXVI) para 12 by one pass and "not verified" by another — reconcile), the Data Policy Framework (EX.CL/Dec.1144(XL) given consistently), the Continental AI Strategy, the African Digital Compact, the AU Interoperability Framework for Digital ID, STYIP 2024–2033, PIDA PAP 2, DES 2022, DAS 2024, CESA 26-35, STISA-2034.
- Current ratification counts on the AU treaty status lists for Malabo, ACDEG, the Public Service Charter, the Decentralisation Charter, the Statistics Charter, the Social Protection Protocol and the Disability Protocol.
- Malabo article numbering (taken from a reproduction, not the AU PDF); the paragraph of Art. 14 that carries the adequacy rule.
- AfCFTA DTP article numbers against the deposited text; the Digital Payments and Digital Identities annex texts, which are not public.
- CAMCR 2019 and 2022 declaration texts (the 100 % / 80 % registration targets are as reported by allAfrica).
- The ACHPR Model Law on Access to Information URL and clause list.
- The Framework and Guidelines on Land Policy in Africa provisions on land information systems.
- ATU-R Report 004-0 (satellite licensing status) — file too large to parse.
- STISA-2034 primary text for the R&D benchmark.
- ARSO's provision on adoption of international standards; PAQI Member-State obligation text.
- Whether the DTS mid-term review has revised any 2030 target — this decides the vintage the rubric freezes.
