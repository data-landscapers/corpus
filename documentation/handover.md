...
- **Retention is conditional now** *(Bill, 2026-08-18)*: a superseded edition is deleted unless somebody downloaded it, PDFs and CSVs, forward only — nothing published on or before 2026-08-18 is ever touched. A Cloudflare Worker records which paths are fetched (`workers/download-log/`), `scripts/prune-editions.py` acts on it in RENDER Step 6a, and every uncertainty resolves towards keeping the file. `documentation/delete-unless-downloaded.md`, and §9 of the design record carries the amendment.
