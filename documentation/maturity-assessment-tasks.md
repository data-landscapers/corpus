...
### C2. Draft the rubric, chapter by chapter, with a review after each — **Cowork** drafts, **CC** reviews — L, the longest task — *Instruments and systems of Governance, Finance, DPI, Infrastructure, Digitalisation and Technology accepted and cut 2026-09-23 (83 of 117; Inclusion, Data and the 22 measures to come); checker `lint-maturity-rubric.py`, cut `maturity-rubric-cut.py`, reviews in `maturity-rubric-review.md`*
...
### C3. Define the measures: value, unit, source, band — **Cowork** drafts, **CC** checks the datasets exist — M, inside C2's last leg
