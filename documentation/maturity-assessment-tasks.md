...
### C3. Define the measures: value, unit, source, band — **Cowork** drafts, **CC** checks the datasets exist — M, inside C2's last leg — *drafted 2026-09-24; CC's review returned five items (`maturity-rubric-review.md`); the partner-financing row is Bill's call*
