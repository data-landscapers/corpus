...
### C2. Draft the rubric, chapter by chapter, with a review after each — **Cowork** drafts, **CC** reviews — L, the longest task — *Governance, the Finance instrument and DPI (instruments, systems) accepted and cut 2026-09-23 (64 of 117); checker `lint-maturity-rubric.py`, cut `maturity-rubric-cut.py`, reviews in `maturity-rubric-review.md`*
