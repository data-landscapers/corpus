...
### C2. Draft the rubric, chapter by chapter, with a review after each — **Cowork** drafts, **CC** reviews — L, the longest task — *Governance and the Finance instrument accepted and cut 2026-09-23 (30 of 117); checker `lint-maturity-rubric.py`, cut `maturity-rubric-cut.py`, reviews in `maturity-rubric-review.md`*
