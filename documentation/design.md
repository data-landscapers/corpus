...
- **Alerts for a narrow interest — specified, Bill builds the week of 2026-09-21.** A reader picks a country, a topic or both and gets a weekly email of new matching documents, through Buttondown, which holds the addresses so the site still holds no user record (§1). The implementation steps, the reader text and the decisions are in `documentation/catalogue-alerts.md`.
