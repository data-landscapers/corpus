...
**Generic office hardware is overhead, not a digital-activity line.** Computers, network maintenance and IT equipment purchases are excluded; software, systems, digitalisation, connectivity and biometric lines are recorded. **A ministry's own IT unit** — an information-systems directorate, IT division or ICT cost centre printed as a line of its own — records at `partial` *(2026-09-25)*: it runs the ministry's systems, which are in the frame, and its desktop support and equipment, which are not, and the document does not separate them. A line within it that names a system or software records at `whole`; its equipment, supplies and fuel lines do not record.
