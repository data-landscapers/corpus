...
F = [
 ...
 ("submarine_cable_access", "", "Subsea cable", "category",
  "At or adjacent to cable landing station; Dark fibre connection to landing station; Connected via metro fibre; Inland, via national backbone; Landlocked/no submarine cable access" + UNK, "",
  "How the facility reaches a submarine cable landing station.", "Check submarine cable maps and the operator's connectivity specifications. Landlocked is for the landlocked countries only; an inland site in a coastal country (Nairobi, Johannesburg) is Inland, via national backbone, unless a dark-fibre route is documented."),
