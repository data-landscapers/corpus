...
F = [
 ...
 ("operational_status", "", "Status", "category", "Operational; Under construction; Planned; On hold; Decommissioned" + UNK, "",
  "Whether the facility is running.",
  "Base this on the newest source you can find, preferably from the last 12 months. Status changes quickly, so record the date of that source in comments. On hold: a planned or started project its sponsors have publicly paused."),
 ...
 ("major_shareholders", "major shareholders", "Major shareholders", "text", "", "",
  "The largest shareholders of the first company in the ownership chain that has outside shareholders, with their stakes.",
  "Name that company first ('Of Airtel Africa plc: ...'): it is where control is shared, and often a listed holding company below the ultimate parent. Take up to five from the latest filing (2024 or later), each giving its source. Leave blank where nothing is disclosed."),
 ...
 ("cloud_act_exposure", "", "CLOUD Act", "category",
  ...
  "from ultimate_parent_hq_country, control_category and hyperscaler_*",
  "Whether the US CLOUD Act can compel access to data held at the facility, through its owner or a US cloud provider there.",
  "Set by rule, not judged: Yes when ultimate_parent_hq_country includes USA or control_category is US control (a US-controlled company registered elsewhere); otherwise Partial when any hyperscaler_* is Yes; otherwise No. Unknown when ultimate_parent_hq_country is blank."),
 ...
 ("foreign_dependency_score", "", "Foreign dependency", "category",
  "Low; Moderate; High; Insufficient data", "from ownership_type, control_category, open_source_stack and cloud_act_exposure",
  "A composite of how far the facility depends on foreign owners, technology and law.",
  "Set by rule, not judged. Foreign means foreign equity (ownership_type) or a non-African controller (control_category). High: foreign, and either CLOUD Act exposure Yes or a predominantly proprietary stack. Low: domestic, CLOUD Act exposure No, and a stack not known to be proprietary. Insufficient data: neither ownership nor control known. Moderate: everything else."),
 ...
 ("submarine_cable_access", "", "Subsea cable", "category",
  "At or adjacent to cable landing station; Dark fibre connection to landing station; Connected via metro fibre; Via national backbone; Landlocked/no submarine cable access" + UNK, "",
  "How the facility reaches a submarine cable landing station.", "Check submarine cable maps and the operator's connectivity specifications. Landlocked is for the landlocked countries only; a site in a coastal country far from any landing station (Nairobi, Johannesburg, East London) is Via national backbone, unless a dark-fibre route is documented."),
