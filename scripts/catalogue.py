...
(function(){
  ...
  function drawResults(){
    ...
    document.getElementById('note').textContent =
      'Browsing ' + ROWS.length.toLocaleString() + ' catalogue records. Filter state is in the URL — copy the address bar to share this view.';
  }
...
def main() -> int:
    ...
    payload = {"places": places, "regions": regions, "topics": topics, "cats": cats, "rows": rows}
    ...
    print(f"catalogue: {len(rows):,} records -> site/catalogue/  "
