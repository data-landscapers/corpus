...
<!-- narrative: summary -->
Two accounts of the identity system were published within a week of each other. The World Bank's ID4D diagnostic put [close to 90% of the population without government-recognised identification and about 90% of births unrecorded](https://www.worldbank.org/en/news/feature/2026/07/22/in-the-worlds-youngest-nation-how-do-you-prove-you-exist) on 22 July 2026; six days later the civil-registry directorate [announced a centralised register and a digital national identity card for every adult](https://www.eyeradio.org/civil-registry-to-introduce-digital-system-for-birth-death-and-marriage-registration/), naming no law, budget, timetable, vendor or platform.

The revenue authority [barred cash payment of tax at its own offices on 25 July](https://www.eyeradio.org/revenue-authority-changes-tax-payment-process/) while leaving the digital channel running, and the telecommunications regulator [completed a second increase in the cost of connection on 26 July](https://www.eyeradio.org/you-will-pay-more-for-calls-data-from-tonight-as-second-tariff-adjustment-takes-effect/) without publishing the new prices.
<!-- /narrative -->
