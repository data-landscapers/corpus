...
<!-- narrative: summary -->
Egypt's digital state is dense and its measurements are almost entirely its own. The government reported 105 bodies connected and 100 national databases linked through its digital switch, alongside a digital treasury of reusable verified documents and live trust services ([cabinet readout](https://gate.ahram.org.eg/News/5813424.aspx)) — the hardest inter-agency interoperability figures the wiki holds for any African state, and ministry-reported rather than drawn from a published register.

The regulatory position caught up with the built one only in the past year. The Personal Data Protection Law has been in force since 2020, but its Executive Regulations were issued on 1 November 2025 and its obligations become enforceable from 1 November 2026 at the end of a one-year grace period ([regulations summary](https://accesspartnership.com/opinion/egypt-finalises-executive-regulations-to-the-personal-data-protection-law-pdpl)). The single enforcement award on record rests on tort and custodian's liability rather than on the data-protection law ([judgment note](https://shehatalaw.com/law-update/legal-alert-egyptian-court-judgment-tightens-enforcement-of-privacy-and-data-protection-laws)).

Two figures set the frame. Financial inclusion reached 77.6% of adults at end-2025 ([central bank](https://english.ahram.org.eg/NewsContent/3/562552/Business/Egypt-financial-inclusion-rate.aspx)), while only 15% of popular web content consumed in Egypt is served from inside the country ([content-locality measurement](https://pulse.internetsociety.org/en/blog/2026/06/beyond-the-homepage-measuring-what-it-really-takes-to-keep-web-traffic-local/)).
<!-- /narrative -->
...
Egypt's connectivity position is one of transit strength and domestic thinness. About 15 active international submarine cable systems land in the country, the largest concentration in Africa. Against that, only 15% of popular web content consumed in Egypt is served from inside the country ([content-locality measurement](https://pulse.internetsociety.org/en/blog/2026/06/beyond-the-homepage-measuring-what-it-really-takes-to-keep-web-traffic-local/)) — the country carries other people's transit and hosts little of its own users' traffic.

Spectrum moved further in one transaction than in three decades: 410 MHz awarded across three bands for US$3.5bn in February 2026, which the ICT minister said matched all spectrum allocated in Egypt over the previous 30 years ([award account](https://www.connectingafrica.com/investment/egypt-seals-3-5b-spectrum-deal-with-telcos)). What followed does not read as capacity. Six months after the June 2025 launch the combined 4G and 5G median download speed was 34.77 Mbps against a pre-launch baseline of 37.68 Mbps ([measurement](https://www.ookla.com/articles/5g-north-africa-2026)); Egypt refarmed 2.6 GHz rather than licensing dedicated mid-band, and set no coverage or quality obligation of the kind its neighbours imposed.

Rural fibre is the clearest delivery: more than 1,250 of the 1,450 phase-one Decent Life villages connected by 30 June 2026, from 856 at end-2024 ([operator account](https://www.youm7.com/story/2026/6/30/%D8%A7%D9%84%D9%85%D8%B5%D8%B1%D9%8A%D8%A9-%D9%84%D9%84%D8%A7%D8%AA%D8%B5%D8%A7%D9%84%D8%A7%D8%AA-%D8%AA%D9%88%D8%B5%D9%8A%D9%84-%D8%A7%D9%84%D8%A3%D9%84%D9%8A%D8%A7%D9%81-%D8%A7%D9%84%D8%B6%D9%88%D8%A6%D9%8A%D8%A9-%D9%84%D9%805-%D9%85%D9%84%D9%8A%D9%88%D9%86-%D8%AE%D8%B7-%D9%81%D9%89-1250/7465834)). Data centres are being licensed faster than they are described — ten licences in two years ([licence account](https://www.wearetech.africa/en/fils-uk/news/egypt-bets-on-data-centers-and-ai-to-drive-digital-economy-growth)) — with no capacity figure in megawatts or power arrangement for any licensed site held.
<!-- /narrative -->
...
Against that headline sits a credit position that has not moved. About 16.7 million Egyptian adults had no formal access to credit or other banking services at June 2025, and no fresher measure is held ([lender account](https://techcabal.com/2026/06/08/egypts-blnk-raises-37-million-to-expand-lending/)).

Training is measured by programme rather than nationally. A university artificial-intelligence initiative running since 2022 reports 2,710 students and 763 projects cumulatively ([round account](https://gate.ahram.org.eg/News/5882834.aspx)). The most recent national ICT training total the base holds is 400,000 trainees for 2023/24, and no later figure exists.
...
<!-- narrative: gaps -->
The absences here are concentrated in two places. Egypt's own money is the first: no state appropriation for digital transformation or for the ICT ministry is held, and the FY2026/2027 development plan is not held either, so what the state commits to any of the systems described above cannot be stated. Research capacity is the second: nothing is held on research and development spending, on the applied innovation centre's output, or on compute access for Egyptian researchers.

Two further silences bear on claims made here: no register of the 105 bodies connected to the digital switch exists and no lawful basis for that sharing is published ([cabinet readout](https://gate.ahram.org.eg/News/5813424.aspx)), and no enrolment count exists for any of the three biometric identity channels launched inside the window. Gulf and Indian technology engagement returns no source at all, which given the documented role of Gulf capital in Egyptian infrastructure is a hole in the wiki rather than an absence in the world.
<!-- /narrative -->
