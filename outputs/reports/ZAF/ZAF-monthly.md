...
<!-- narrative: summary -->
A [sovereign artificial-intelligence cloud was brought into service and described as the continent's most powerful](https://techafricanews.com/2026/08/27/south-africa-partnership-launches-africas-most-powerful-sovereign-ai-cloud/). A domestic artificial-intelligence factory [entered a global supercomputer ranking at 36th](https://techafricanews.com/2026/08/26/cassava-ai-factory-ranks-36th-top500/), and a company is [considering a data-centre campus at Coega](https://www.theherald.co.za/news/2026-08-29-power-play-as-company-eyes-ai-data-hub-at-coega/). The human rights commission [opened an inquiry into the sustainability of data centres, and operators have objected](https://www.itweb.co.za/article/sa-data-centre-operators-push-back-amid-sustainability-probe/5yONP7EroNQMXWrb).

Home affairs [blocked about 300,000 identity documents on suspicion of fraud](https://www.sundaytimes.timeslive.co.za/news/2026-08-27-home-affairs-blocks-300000-ids-amid-fraud-crackdown/). The information regulator [called the rate of reported data breaches alarming and issued enforcement notices under the data protection Act](https://www.itweb.co.za/article/inforeg-concerned-by-alarming-rate-of-data-breaches/rxP3jqBE2ZLMA2ye). Subscription fraud against telecommunications providers [is rising, and some of it uses deepfakes](https://www.connectingafrica.com/cybersecurity/sa-telecom-subscription-fraud-surges-ai-deepfakes-on-the-rise-comric).

The [analogue television switch-off still has no date; the programme told Parliament that 290,506 subsidised set-top boxes have been installed and 52,869 registered households cannot be found](https://www.itweb.co.za/article/digital-migration-progress-what-the-numbers-say/VgZeyvJlBgJMdjX9). The social security agency [launched self-service for grant beneficiaries on WhatsApp](https://www.citizen.co.za/alberton-record/news-headlines/local-news/2026/08/28/sassa-rolls-out-whatsapp-self-service-for-grant-beneficiaries/). It is the second national body this year to offer a public service through a private messaging platform.
<!-- /narrative -->
...
The [National Radio Frequency Plan 2026](https://www.icasa.org.za/legislation-and-regulations/national-radio-frequency-plan-2026), approved by the minister on 2 July, was gazetted on 24 July. It aligns the allocation table from 8.3kHz to 3,000GHz with the ITU Radio Regulations and the SADC and African Telecommunications Union plans. The [IMT Roadmap 2026](https://www.gov.za/documents/notices/electronic-communications-act-international-mobile-telecommunications-roadmap-2) was published for consultation the same day; its tables record 794MHz assigned to licensees and 18,831MHz still to be assigned. The regulator's [accompanying statement, of an increase from 850MHz to at least 18,588MHz by 2030 and a 215% rise in high-demand spectrum](https://www.icasa.org.za/news/2026/icasa-publishes-draft-imt-roadmap-and-implementation-plans), does not match the gazetted tables. Allocation of the 6GHz band was [deferred pending a feasibility study](https://www.citizen.co.za/news/malatsi-approves-2026-national-radio-frequency-plan/).

Herotel, a domestic provider with more than 350,000 customers, was [named Amazon Leo's South African distributor](https://www.dailymaverick.co.za/article/2026-07-15-herotel-chosen-as-amazon-leo-distributor-in-maziv-race-for-satellite-internet/) for a 2027 launch. Starlink [began service in its 27th African country](https://mybroadband.co.za/news/broadband/658586-starlink-launches-in-27th-african-country-before-south-africa.html) and is still not licensed in South Africa. The department told Parliament its draft satellite policy direction was ["of general application and not directed at any specific operator"](https://pmg.org.za/committee-question/39540/). The state-backed [BrainSAT](https://mybroadband.co.za/news/broadband/656335-state-backed-south-african-satellite-internet-and-phone-company-launched.html) venture launched on Emirati infrastructure.

On 20 August the minister [told the International Space Summit Africa that low-earth-orbit services are part of the country's digital future, and that licensing is for the regulator alone to decide](https://www.itweb.co.za/article/malatsi-backs-leo-operators-as-icasa-calls-the-shots/Gb3BwMWaPAEv2k6V). The minister's December directive on equity-equivalent schemes has not been resolved. Starlink's operator [asked the regulator for flat per-licence spectrum fees, blanket licensing of terminals and a minimum licence term of ten years](https://techafricanews.com/2026/08/20/spacex-urges-south-africas-icasa-to-rethink-proposed-satellite-spectrum-fees/), and for consolidated guidance on the 30% equity threshold. Amazon's Kenyan subsidiary [applied for a fifteen-year gateway licence](https://techafricanews.com/2026/08/20/who-will-control-africas-satellite-internet-layer-starlink-amazon-leo-or-the-carriers/).

Comsol [began selling wholesale access to a national 5G-only home-broadband network; resellers own the customer relationship, and the first ISP is due to go live in September](https://www.techcentral.co.za/south-africa-to-get-a-new-national-5g-broadband-network/285080/). Its chief executive agreed that it is the kind of wholesale open-access network the state tried for more than a decade to license and then abandoned. The network is privately financed, following Nedbank Private Equity's exit in December. No coverage footprint, site count or wholesale price has been published.

Cape Town's municipal planning tribunal [approved two Equinix data centres](https://www.moneyweb.co.za/news/ai/giant-data-centres-get-the-first-green-light-from-cape-town-tribunal/) over objections from three civil-society organisations. The application did not state water or electricity demand; both are left to the site development plan. Reuters put the planned load at about 170MW. NTT Data South Africa confirmed it had [sold seven facilities and leased them back](https://www.itweb.co.za/article/itweb-tv-ntt-data-sa-prioritises-services-over-data-centre-ownership/DZQ58vV8m4aMzXy2). Google held its first African cloud summit in Johannesburg and announced an exchange port in the Eastern Cape. The President welcomed hyperscaler commitments and [said government is building its own cloud through the CSIR](https://mybroadband.co.za/news/cloud-hosting/656975-south-africa-building-its-own-cloud-infrastructure-says-ramaphosa.html).

Sixteen years after the original 2010 deadline, with estimates of households still relying on analogue ranging from about 500,000 to between 2.2m and 4.5m, the communications department [told Parliament that no date has been set for the analogue television switch-off](https://techcentral.co.za/still-no-end-in-sight-to-south-africas-digital-migration-saga/284937/).

On 7 September a development bank and National Planning Commission study [costed universal, meaningful household broadband at about R140bn under least-cost deployment and well above R200bn under fibre-led scenarios, or R108bn to R142bn in 2025 real terms depending on the economic scenario](https://www.nationalplanningcommission.org.za/assets/Documents/SA%20Digital%20Infrastructure%20Investment%20Study.pdf). It uses 0.76 square-kilometre hexagonal-grid mapping and is set against the 2030 development plan and the 2050 infrastructure plan. No appropriation, delivery vehicle or start date is attached to any scenario. The national broadband map launched in March has not been published. The competition authority [puts wired internet prices up 3.5% and wireless up 4.1% in the first half of 2026, against cumulative headline inflation of 3.8%](https://www.itweb.co.za/article/sas-internet-costs-climb-but-other-bills-rise-faster/mYZRXv9gbykMOgA8), compared with rises of 18.6% and 6.4% against inflation of 36% in the six years to July 2026. It is the first period in which a service the authority treats as essential has risen faster than inflation.
...
The telecommunications industry body's sector report records [14,897 subscription fraud cases in the twelve months to April 2026, up 307% on the year before, with every month higher than the same month a year earlier](https://www.connectingafrica.com/cybersecurity/sa-telecom-subscription-fraud-surges-ai-deepfakes-on-the-rise-comric). Social engineering by message and phone has overtaken technical intrusion, and AI-generated voices and messages are being used. The report describes a phase of systemic risk in which cyberattack, fraud, infrastructure crime, energy volatility and supply-chain disruption reinforce each other. The figures come from members' own case records, not from the police or a regulator.

The financial regulator's fourth regulatory actions report records [140 public warnings and R2.89bn in penalties on 76 persons in the year to March](https://www.itweb.co.za/article/social-media-is-sas-biggest-financial-scam-vehicle/8OKdWMDXxQrMbznQ). Most warnings concerned unregistered providers promoting investments on social media; about a fifth involved impersonation of licensed institutions, the regulator or its staff. [Over R2bn of the total is a single deepfake-advertising case](https://www.itweb.co.za/article/social-media-is-sas-biggest-financial-scam-vehicle/8OKdWMDXxQrMbznQ), in which reconsideration of the debarment and penalty was still pending at the report date. A forensics firm puts [attacker dwell time at 18 days in 2025, with some intrusions completed within a day](https://www.itweb.co.za/article/ransomware-gangs-intensify-attacks-in-sa/lLn147mQzxP7J6Aa), and attributes this to ransomware-as-a-service and automated reconnaissance. The figure is from the firm's own cases.

The public service and administration department is [tendering for a training programme for information security officers across the public service](https://www.itweb.co.za/article/top-ict-tenders-dpsa-targets-info-security-officer-training/WnpNgM21Zx87VrGd), to implement the directive on public service information security. No officer count, curriculum, budget or compliance deadline has been stated.

On 24 August the science minister told the National Assembly that the late-May breach of the national supercomputer was caused by [vulnerabilities associated with the legacy high-performance computing system](https://www.itweb.co.za/article/cause-of-breach-on-sas-supercomputer-revealed/KPNG878NLeGq4mwD). Attackers reached parts of the system and installed crypto-currency mining malware, and [ageing components are technically constrained or no longer fully supported by their original vendors](https://www.itweb.co.za/article/cause-of-breach-on-sas-supercomputer-revealed/KPNG878NLeGq4mwD). A [remediation programme covering access controls, privileged-access management, network segmentation, patch management and monitoring has since been carried out, with forensic support and independent assurance from the council's own specialists](https://www.itweb.co.za/article/cause-of-breach-on-sas-supercomputer-revealed/KPNG878NLeGq4mwD). No cost, data loss or outage duration was stated.

A provider [that runs verification checks for Cell C, EasyEquities and Bidvest Bank reported a breach on 9 September](https://www.connectingafrica.com/cybersecurity/sa-s-cell-c-easyequities-and-bidvest-bank-warn-customers-of-data-leak).
...
The department put the smart ID service in bank branches at 296 branches and more than 385,000 applications in four months when [Absa joined it](https://www.sanews.gov.za/south-africa/home-affairs-announces-absa-joining-banking-sector-provide-smart-ids). Operation Vulindlela's quarterly report [gave 203,887 applications across 171 branches](https://www.treasury.gov.za/comm_media/press/2026/Operation%20Vulindlela%20Progress%20Report%20Q1%20-%202026.pdf); the two figures cover different periods. Mobile operators and the justice department agreed a framework to [replace document checks in SIM registration with real-time departmental verification](https://techcabal.com/2026/07/20/south-africa-wants-every-sim-card-to-become-a-trusted-digital-id/). On 6 June, the last day of comment on the draft Identification Regulations, a research organisation asked the department to suspend them until there is a published digital identity policy, an enacted National Identification and Registration Bill and shown compliance with the data protection Act. It argued that the regulations set up biometric enrolment, trusted-entity accreditation and real-time verification with no formal role for the Information Regulator. The submission has not been published online.

On 29 July the Western Cape High Court [held four categories of exclusion in the birth-registration regulations unconstitutional](https://www.timeslive.co.za/news/south-africa/2026-07-29-court-rules-birth-registration-exclusions-unconstitutional/), allowed 18 months for amendment, and held that the orders need no Constitutional Court confirmation.

Home Affairs said its electronic travel authorisation had [refused more than 5,500 travellers](https://www.sundaytimes.timeslive.co.za/news/2026-07-28-home-affairs-to-expand-digital-visa-system-after-blocking-5500-travellers/) since October 2025. The system [went live at OR Tambo, Cape Town, King Shaka and Lanseria airports from 12 August, with 6,126 fraudulent applications rejected — 2.8% of pilot submissions — and all visa types to be covered by the end of the year](https://www.itweb.co.za/article/digital-travel-system-takes-off-at-four-sa-airports/O2rQGqAERbnqd1ea). The department publishes no statistical series, and the four rejection counts it has given this year use different bases.

On 17 August the department [launched a My Home Affairs Online portal to help people find a participating branch, putting the network at 372 branches and more than half a million users](https://www.biometricupdate.com/202608/south-africa-advances-broader-digital-identity-and-public-services-ecosystem), and described it, with the electronic travel authorisation, as part of the national digital public infrastructure roadmap. Its downtime statement a week earlier put the number of branches at more than 408. The travel authorisation [drew questions from the tourism industry about its R500 fee and the consultation behind it](https://www.tourismupdate.com/article/schreiber-faces-industry-questions-over-eta).

A published critique argues that the draft digital-identity regulations [under-specify verifier authentication, transparency about the purpose of a request, and enforcement of data minimisation](https://it-online.co.za/2026/08/11/share-doesnt-mean-surrender-when-it-comes-to-digital-id/). It calls for binding rules requiring a requesting party to prove who it is, state why it is asking and log every share, so that institutions, not the consenting citizen, are accountable.
...
The Labour Court [stayed disciplinary proceedings](https://www.itweb.co.za/article/ai-hallucinations-strike-again-at-sa-courts/Pero3qZ31oGvQb6m) against three municipal employees on prima facie evidence that a ruling relied on authorities that do not exist. SARS said that [100% of verification cases and 88.41% of complex audits](https://techcabal.com/2026/07/27/ai-south-africas-taxman/) are selected by automated risk assessment. Huawei reported [1,400 local partners accounting for 94.7% of its local revenue](https://techafricanews.com/2026/07/27/huawei-calls-for-stronger-digital-infrastructure-to-scale-ai-in-south-africa/) at its partner event in Sandton, where South Africa's founding membership of the China-led World AI Cooperation Organisation was noted.
...
Provincial police warned that [creating and sharing artificial-intelligence face-swap images of oneself in police uniform can breach section 68 of the South African Police Service Act 68 of 1995, which makes impersonating a police official an offence](https://www.itweb.co.za/article/saps-sounds-alarm-over-ai-generated-police-images/lwrKx73YyNOqmg1o). No case or charge has been reported.
