...
*Of 16 bodies, instruments and systems on this place's ledger, 11 changed position between 2025-09-01 and 2026-09-21, 2 did not, 3 carry no stated baseline, and 0 are ***Not held*** at both ends.*

*Shape check, run before the comparison: 17 sources for this place in the window — 4 in the earlier half (2025-09 to 2026-01), 13 in the later (2026-02 to 2026-09). **The earlier half of the window is thin: this is a shorter comparison wearing a longer label**, and the movement below rests mostly on the later half.*
...
<!-- narrative: summary -->
North Africa's ledger opens thin and moves through the Arab League rather than through the AU's continental instruments: two separate AI-ethics charters, a newly staffed AI governance committee, and a conference of civil-status directors, none of them AU-organised. The one running infrastructure programme on the ledger — the France–Tunisia leg of the Medusa submarine cable — reached service during the period, while Ookla's year-one measurement of the region's 5G launches found the aggregate mobile experience worse than before them in three of four markets. PAPSS's North Africa footprint reached four of the region's five states with Algeria's accession, and a stablecoin-based neobank entered the repository as the one private-sector system tracked here.
<!-- /narrative -->
...
| AI Forward Summit 2026 | The organisation preparing its 2025 summit, set for Tunis from 30 November to 3 December 2025 under the Arab League secretary-general's patronage (2025-09) | [A regional artificial-intelligence summit opened at Yasmine Hammamet, Tunisia, on 9 September 2026, organised by the Arab information and communication technologies organisation with Tunisia's communication technologies ministry under the theme 'Shaping the future of AI: from vision to value'. A secretary of state told the opening that the summit has become an important forum for dialogue on the future of AI in Arab countries and on making the technological revolution a lever for development, cooperation and peace; the Arab League secretary-general's participation was presented as a commitment to joint Arab action.](https://www.radionationale.tn/article/6aa1b13f0d094f0934cf67ef/) | No change, an annual summit held again |
...
| Arab Cybersecurity Ministers Council coordination with the League's General Secretariat | ***Baseline not held*** | [The League of Arab States' General Secretariat hosted a meeting on 16 September 2026 at which a delegation from the Council's own General Secretariat, headed by its secretary-general, briefed member states' permanent representatives on strengthening cooperation between the Council, its member states and the League's sectors and departments. It was chaired by an assistant secretary-general of the League. No decision, workplan or instrument came out of the meeting on the account held](http://www.lasportal.org/en/news/Pages/NewsDetails.aspx?RID=4051) | ***Baseline not held*** |
...
Two Arab-League AI-ethics instruments sit on the ledger, adopted within weeks of each other in mid-2025 and routinely conflated with one another: the Arab Charter for AI Ethics is a general, non-binding six-pillar instrument covering forty principles, while the ALECSO charter is scoped narrowly to education, culture and scientific research and asks member states to amend domestic law. Neither carries an enforcement mechanism, and the AI governance committee's own working group tasked with "activating" the former has a chair but no published output as at this report.
<!-- /narrative -->
...
| VaulFi stablecoin-powered neobank | Did not exist | [Algerian- and Egyptian-founded startup building a stablecoin-based neobank offering euro-denominated digital accounts across North Africa with cross-border settlement in minutes rather than days; live user accounts at the time of report, with stablecoin-powered cards stated to launch within weeks](https://techcabal.com/2026/02/24/francophone-weekly-by-techcabal-013/) | Movement |

### National statistics

| Body, instrument or system | At 2025-09-01 | At 2026-09-21 | Progress |
|---|---|---|---|
| AMU-Statistics Sweden cooperation on migration statistics | ***Baseline not held*** | [A 2023-2026 cooperation project between Statistics Sweden and the Arab Maghreb Union has funded a migration-statistics consultant supporting the Union and its member states; the Union tendered an audit of the consultant's fees for January to June 2026. No output of the project is held](https://maghrebarabe.org/6762/) | ***Baseline not held*** |

<!-- narrative: systems -->
The one physical infrastructure project on the ledger reached service: the Bizerte–Marseille leg of the Medusa submarine cable, EU co-financed at €9.6m of a €32m budget, went operational in June, landing at Bizerte and joining the wider 17-point Medusa system. Against that single advance, the region's own 5G rollouts measure worse a year on: Ookla's retrospective found the aggregate mobile experience below its pre-launch baseline in three of the four markets that had launched by mid-2025, Algeria's later rollout the exception. Payments infrastructure moved on two fronts — the Arab Payment Systems Commission opened a fraud- and AI-in-verification agenda with nothing yet adopted, PAPSS's regional footprint reached four of five states, and a stablecoin-based neobank entered the repository as the period's one private-sector system.
<!-- /narrative -->
