...
*Of 87 bodies, instruments and systems on this place's ledger, 56 changed position between 2025-09-01 and 2026-09-11, 5 did not, 25 carry no stated baseline, and 1 is ***Not held*** at both ends.*

*Shape check, run before the comparison: 165 sources for this place in the window — 37 in the earlier half (2025-09 to 2026-02), 128 in the later (2026-03 to 2026-09). **The earlier half of the window is thin: this is a shorter comparison wearing a longer label**, and the movement below rests mostly on the later half.*
...
<!-- narrative: summary -->
On 2026-07-19 at Lungi the ECOWAS Authority [adopted a Revised Supplementary Act on the Protection of Personal Data](https://www.ecowas.int/wp-content/uploads/2026/07/Final-Communique_-ENG.pdf), superseding the Act of February 2010, welcomed Council instruments on open data, electronic communications, digital governance and roaming, and approved a Regional Cybersecurity Coordination Mechanism. None of those texts is published with the communique.

PI-SPI, the union's instant-payment rail, [reached 30 million connected users](https://www.togofirst.com/en/finance/2407-19672-bceao-instant-payment-platform-connects-30-million-users-in-less-than-10-months) by 2026-07-20 on 80 connected institutions against 45 at launch, and the BCEAO [extended the connection deadline](https://lefaso.net/spip.php?article147670) it had set for 30 June 2026.
<!-- /narrative -->
...
| Cotonou Declaration on digital transformation in West and Central Africa | Did not exist | [Adopted by West and Central African states, committing to a single digital market by 2030; no implementation report, work plan or secretariat held in the nine months since](https://lanation.bj/actualites/transformation-numerique-en-afrique-de-louest-et-du-centre-les-dirigeants-sengagent-a-oeuvrer-pour-des-progres-tangibles) | Movement |
| Draft Directive Governing Electronic Communications in West Africa | Did not exist | [A three-day validation workshop advanced the draft directive toward ministerial approval; no adopted text, ministerial date or transposition deadline is published](https://www.ecowas.int/ecowas-commission-convenes-validation-workshop-for-the-draft-directive-governing-electronic-communications-in-west-africa/) | Movement |
| ECOWAS | Vision 2050 in force; the Supplementary Act of February 2010 the newest regional digital instrument the base held | [a new president of the commission in office from 31 August 2026](https://www.ecowas.int/ecowas-holds-welcome-and-send-off-ceremony-for-incoming-and-outgone-statutory-appointees-as-h-e-general-birame-diop-assumes-office-as-new-president-of-the-ecowas-commission/) | Movement |
| ECOWAS project-preparation pipeline for digital connectivity | Did not exist | [Digital connectivity placed alongside transport, energy and water in the pipeline for development finance and private investment; no project list, envelope or first report held](https://www.ecowas.int/wp-content/uploads/2026/07/Final-Communique_-ENG.pdf) | Movement |
...
| Praia framework and action plan on information integrity | No regional instrument on information integrity (2025-08) | [A twenty-page model policy framework and a ten-year action plan for 2026-2036 were adopted at the Praia ministerial conference, operationalised across four domains with outcomes and indicators, and reported in July 2026 as committing fifteen West African states to information-integrity laws (2026-07)](https://ang.gw/cabo-verde-conferencia-regional-sobre-integridade-de-informacao-em-africa-ocidental-e-no-sahel-adota-quadro-politico-e-plano-de-acao-para-2026-2036/) | Movement |
| UEMOA land registration harmonisation directive | No regional rule on land registration (2025-08) | [Eight member states approved a draft directive harmonising land registration and titling rules across the union in June 2026, covering the establishment of urban land information systems; no domestic transposition is recorded (2026-06)](https://croissanceafrique.com/uemoa-directive-sur-lharmonisation-des-regles-regissant-limmatriculation-et-la-propriete-fonciere-au-sein-de-lunion/) | Movement |
| WATRA (West Africa Telecommunications Regulators Assembly) | Working groups established about two years earlier, with no technical output on record | [Five technical reports finalised, a 23rd general assembly held at Lome, and a regional position stated on submarine-cable resilience](https://guardian.ng/news/watra-rallies-africa-for-regions-216b-digital-economy/) | Movement |
| West African Backbone Managers Network (ROA-BN) | ***Baseline not held*** | [Operating, with its headquarters inaugurated at Kagbelen in Conakry on 10 November 2025 and the backbone managers of eight countries as members - Guinea, Burkina Faso, Cote d'Ivoire, Mali, Niger, Sierra Leone, Senegal and Ghana. Its stated mission is interconnection, the pooling of infrastructure and the harmonisation of digital policy between members; its president says the member countries are already interconnected and that the work now is redundancy, naming Mali's links to Cote d'Ivoire, Guinea and Senegal, alongside training for member operators' staff and the sale of transit capacity between them](https://guineematin.com/2025/11/11/connectivite-regionale-le-siege-du-reseau-ouest-africain-des-backbones-ouvert-a-conakry/) | ***Baseline not held*** |
...
The Regional Cybersecurity Coordination Mechanism the Authority [approved on 2026-07-19](https://www.ecowas.int/wp-content/uploads/2026/07/Final-Communique_-ENG.pdf) is a body rather than a declaration, and the base holds nothing else on it: no terms of reference, seat, budget or staffing.

WATRA closed a two-year working-group cycle at Ouagadougou on 2026-04-12, [finalising five technical reports](https://guardian.ng/news/watra-rallies-africa-for-regions-216b-digital-economy/) on 5G deployment, submarine-cable resilience, cybersecurity frameworks, consumer protection and non-geostationary satellite regulation. None of the five is held here.

The Alliance of Sahel States, which severed its ECOWAS ties in 2024, is building a parallel layer. Niger's prime minister [enrolled for the AES passport on 2026-07-16](https://anp.ne/passeport-biometrique-aes-le-premier-ministre-nigerien-zeine-senrole/); Burkina Faso [enrolled its residents in Mali](https://afriktimes.info/2026/06/02/aes-diaspora-identification-successful-pilot-phase-in-bamako-for-the-instant-production-of-documents/) in June 2026, a first on another member's soil.
<!-- /narrative -->
...
| ECOWAS Supplementary Act A/SA.2/01/10 on Electronic Transactions | ***Baseline not held*** | [The community's own act on electronic transactions, adopted alongside the companion act on personal-data protection this ledger holds separately; the full text is now held](https://www.ecowas.int/wp-content/uploads/2025/05/SIGNED-Electronic-Transaction-Act.pdf) | ***Baseline not held*** |
...
| National accounting councils required of member states | The obligation standing with the newest member state's council not established | [In force since 1997 and requiring each member state to establish a national accounting council; one member state launched its own in August 2026, twenty-nine years on](https://www.dge.gouv.ci/sites/default/files/tableau/TEXTES%20COMMUNAUTAIRES%20CLASSSIFIES/UEMOA/DIRECTIVE/Directive%20n%C2%B003-97-CM-UEMOA%20portant%20cr%C3%A9ation%20d%27un%20Conseil%20National%20de%20la%20Comptabilit%C3%A9%20ds%20l%27Uemoa..pdf) | Movement |
| Regional certified electronic signature | Did not exist | [The Commission has set out a programme towards a certified electronic signature usable across West Africa; no standard, root authority or member-state adoption is on file](https://www.ecowas.int/towards-a-certified-electronic-signature-in-west-africa/) | Movement |
...
The Revised Supplementary Act on the Protection of Personal Data [was adopted on 2026-07-19](https://www.ecowas.int/wp-content/uploads/2026/07/Final-Communique_-ENG.pdf) on the Council of Ministers' recommendation, replacing the Act of February 2010 against which national bills across the region have been drafted. The communique neither reproduces nor summarises it and the base holds neither instrument, so the supersession can be recorded and its content cannot.

Two AI instruments sit at different stages. ECOWAS [resolved in January 2026](https://prnigeria.com/2026/01/24/ecowas-adopts-digital-roadmap/) to develop a regional framework, and no draft is held six months on. Outside the bloc's machinery, six states [adopted shared AI governance guidelines on 2026-07-06](https://www.wearetech.africa/en/fils-uk/news/tech/six-francophone-west-african-countries-unite-on-ai-governance-framework), advisory rather than binding.

Harmonisation moved furthest where an instrument had operational consequences. The directors-general of the national statistical institutes [approved methodological guides](https://www.ecowas.int/ecowas-concludes-meeting-of-directors-general-of-national-statistical-institutes-by-adopting-new-guidelines-for-regional-statistical-harmonization/) for the industrial production index, the business register and public debt statistics at Dakar on 2026-07-31, and three states [brought a free-roaming arrangement into effect at Lome on 2026-04-24](https://techreviewafrica.com/news/5159/senegal-togo-and-benin-launch-free-roaming-initiative).

The BCEAO's connection obligation slipped. Interoperability [was to be mandatory from 30 June 2026](https://www.fratmat.info/article/2641755/economie/uemoa-linteroperabilite-des-paiements-devient-obligatoire-des-le-30-juin-2026); the central bank then [set 30 September 2026 for banks, e-money issuers and payment institutions and 30 June 2027 for microfinance institutions](https://lanation.bj/economie/paiements-instantanes-dans-luemoa-nouveaux-delais-pour-la-connexion-a-la-plateforme-pi-spi).
<!-- /narrative -->
...
| EllaLink Mauritania branch | Launched at Nouadhibou in July 2025, with nothing laid | [Coastal landing complete, offshore laying scheduled for August 2026 and commissioning expected in the first quarter of 2027](https://ami.mr/fr/archives/294524) | Movement |
| Nigeria-Burkina Faso connectivity partnership | Did not exist | [Technical teams to assess routes through Niger and through Benin, on a stated aim of halving the cost of internet access in Burkina Faso](https://techafricanews.com/2026/08/13/nigeria-and-burkina-faso-explore-project-bridge-to-cut-internet-costs-by-50/) | Movement |
| Second submarine cable bid evaluation | A second submarine cable planned across five member states (2025-10) | [An evaluation committee spanning the five participating states met at Abuja from 29 June to 10 July 2026 to assess bids for the cable's capacity (2026-07)](https://www.ecowas.int/ecowas-commission-hosts-evaluation-committee-meeting-for-west-african-submarine-cable-capacity-under-wardip/) | Movement |
| Via Africa submarine cable | Did not exist | [A consortium memorandum signed by Canalink, GUILAB, International Mauritania Telecom, the Orange group, Sonatel and Silverlinks for a Europe-to-South-Africa system landing in Mauritania, Senegal, Guinea, Cote d'Ivoire and Nigeria; no cost, contract or in-service date held](https://techafricanews.com/2026/05/13/via-africa-project-to-launch-new-subsea-cable-strengthening-europe-africa-connectivity/) | Movement |
| West Africa Peering Forum | Did not exist | [The 2026 forum drew 281 participants from 23 countries for technical sessions on exchange-point and peering development; the published report records the host country's own exchange point still carrying under 1 Gbps of traffic after nearly ten years, alongside a newly announced second national exchange point with five connected members](https://isoc.bj/wp-content/uploads/2026/07/Rapport-WAPF-2026-Version-française.pdf) | Movement |
...
| Central bank supervisory position on bank cyber-risk | ***Baseline not held*** | [The regional central bank's Monetary Policy Committee, meeting in Dakar on 9 September 2026, found the union's banking sector fundamentals sound - bank liquidity near FCFA 7,000 billion, credit to the economy growing and a solvency ratio above the regulatory norm - while calling on banks to remain vigilant against cyberattacks.](https://www.financialafrik.com/2026/09/10/uemoa-pres-de-7-000-milliards-fcfa-de-liquidites-mais-la-bceao-appelle-les-banques-a-la-vigilance/) | ***Baseline not held*** |
| ECOWAS Directive C/DIR.1/08/11 on Fighting Cyber Crime | ***Baseline not held*** | [The community's own cybercrime directive, the instrument the member states' national cybercrime statutes are made against; the full text is held, recovered by optical character recognition from an image-only scan](https://www.ecowas.int/wp-content/uploads/2025/05/SIGNED-Cyber-Crime.pdf) | ***Baseline not held*** |
...
| ENBIC (ECOWAS National Biometric Identity Card) | Operationalised by six member states, with no rollout held in the largest | [Rolled out by Nigeria in November 2025 and deployed in the field in Guinea-Bissau under a cross-border traders' project](https://thewhistler.ng/nigeria-unveils-ecowas-id-card-to-boost-regional-travel-security/) | Movement |
| Roadmap from foundational identification to the regional biometric card | A regional biometric card issued by member states with no roadmap connecting it to their own registers (2025-08) | [The Commission consulted member states in February 2026 on a roadmap from national foundational identification systems to the regional biometric card, which is the first attempt on the record to connect the two layers (2026-02)](https://www.ecowas.int/ecowas-holds-virtual-consultation-with-member-states-for-the-development-of-a-roadmap-from-foundational-identification-systems-to-the-ecowas-national-biometric-id-enbic/) | Movement |
...
The issuer layer underneath grew faster than the rail. The union's banking commission counts [78 institutions offering electronic money at the end of 2025 against 63 a year earlier, and provisional turnover across seventeen active issuers at FCFA 323.2bn, up 12%](https://www.horonyafinance.com/umoa-la-monnaie-electronique-gagne-du-terrain-les-encours-bondissent-de-352-en-2025/). Two cross-border tracks opened above the union rail, neither with an earlier position in the base: the BCEAO [is participating in the ECOWAS Payment and Settlement System](https://www.financialafrik.com/2026/07/28/cedeao-la-bceao-prepare-levolution-des-paiements-transfrontaliers/) and is preparing accession to the continental system through a six-month pilot with more than 80 commercial banks.

Identity credentials advanced on both sides of the region's split. Nigeria [issued the ECOWAS biometric card from November 2025](https://thewhistler.ng/nigeria-unveils-ecowas-id-card-to-boost-regional-travel-security/), Niger [began mass enrolment for the confederal card](https://www.lesahel.org/carte-nationale-didentite-biometrique-aes-lancement-de-lenrolement-de-masse-sous-le-signe-de-la-souverainete-numerique/), and Mali's passport [passed from a French supplier to a Chinese one](https://idtechwire.com/mali-launches-e-aes-biometric-passport-taps-chinas-emptech-in-digital-sovereignty-move) after a data-transfer dispute.

Capacity added to the region was commercial: an operator [added 2Africa West capacity to its own network](https://www.mobileeurope.co.uk/csquared-boosts-internet-resilence-integrating-with-2africa-west/) after three multi-country outages in 28 months, and a six-member consortium [signed a memorandum on 2026-05-13](https://techafricanews.com/2026/05/13/via-africa-project-to-launch-new-subsea-cable-strengthening-europe-africa-connectivity/) for a new subsea system, with no cost or in-service date on record.
<!-- /narrative -->
...
| AGRHYMET-ENABEL land-degradation monitoring capacity programme | ***Baseline not held*** | [A regional project run by the AGRHYMET regional centre with Belgian development funding across Burkina Faso, Mali, Niger and Senegal has trained 236 specialists in satellite-image interpretation and land-cover mapping, the Trends.Earth tool for assessing land degradation, the EX-ACT tool for soil and vegetation carbon estimation, and mobile data collection on KoboToolbox; the countries report better harmonisation of monitoring tools and methods, and the carbon accounting it enabled found the land-use sector substantially under-estimated in earlier nationally determined contributions](https://agrhymet.cilss.int/2025/11/23/cop30-degradation-des-terres-et-sequestration-du-carbone-enabel-agrhymet-devoile-des-resultats-prometteurs-au-sahel/) | ***Baseline not held*** |
...
<!-- narrative: capacity -->
Capacity work in the window is two small, dated interventions rather than a programme. [Thirty-eight professionals from member states and partner institutions were trained at Lomé between 4 and 6 August to assess the maturity of national incident response teams](https://www.ecowas.int/ecowas-advances-regional-cybersecurity-cooperation-through-sim3-auditor-capacity-building-programme/) — auditors for a maturity model, which is capacity to measure capacity rather than to operate.
<!-- /narrative -->
...
| World Bank commitment to the WARDIP series | US$293.00m, the first series (2023-11-07) | [US$430.00m across the two series, after US$137.00m was approved on 2026-03-11](https://documents1.worldbank.org/curated/en/099110923155592015/pdf/BOSIB00f52bbfa0b60b39402a346c5434ee.pdf) | Movement |
...
<!-- narrative: finance -->
The regional layer's financing is a lender's. WARDIP's first series [committed US$293.00m](https://documents1.worldbank.org/curated/en/099110923155592015/pdf/BOSIB00f52bbfa0b60b39402a346c5434ee.pdf); a [second series of US$137.00m was approved on 2026-03-11](https://projects.worldbank.org/en/projects-operations/project-detail/P500628) for Benin, Liberia and Sierra Leone, taking the World Bank's commitment to US$430.00m.

The central bank also opened the question it had held closed: having refused cryptoassets legal tender, it [ran a questionnaire to fintech operators, established a C-CRYPTO committee and held an international conference in May 2026](https://www.financialafrik.com/en/2026/08/26/regulation-of-cryptoassets-in-the-uemoa-between-financial-innovation-and-preservation-of-monetary-stability/), with no instrument yet issued. The bloc's own contribution is procedural: the Authority [directed the Commission to prioritise digital connectivity](https://www.ecowas.int/wp-content/uploads/2026/07/Final-Communique_-ENG.pdf) in its project-preparation pipeline. No project list or envelope is held, nor any digital budget line of ECOWAS, the UEMOA Commission or WATRA, so what the region spends on the layer above cannot be stated at either end of the period.

Equity is the one instrument that moved on its own account. On 9 August the continental development bank [approved a EUR10.5m pooled investment toward the first close of a pan-African start-up fund](https://www.africaglobalfunds.com/news/investors/afdb-approves-105m-investment-in-tech-startup-fund/), mainly in Francophone West Africa. What it buys will be visible only in the companies it later backs.
<!-- /narrative -->
...
<!-- narrative: gaps -->
Six named objects carry no position at either end, and each was searched on 2026-08-05. Four searches returned published documents the base does not hold: the region's own digital sector strategy for 2024-2029, the community budget for 2026-2028, WATRA's technical reports, and a headquarters complex China financed for the ECOWAS Commission. Two returned nothing: no regional digital skills programme of ECOWAS, the UEMOA Commission or WATRA, only single events; and neither the statistical policy nor the regional statistical programme the July 2026 meeting was implementing. These are gaps in this record rather than in the region's activity, and acquisition lines have been raised.

The searches expose the report's own pattern: almost every instrument here is visible through a member state, a central bank, an operator or a press account of a meeting, and almost none through a publication of the body that made it.
<!-- /narrative -->
