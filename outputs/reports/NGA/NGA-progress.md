---
title: Nigeria — progress report, 2025-08-01 to 2026-08-25
compiled: 2026-08-25
...
# Nigeria: progress report, 2025-08-01 to 2026-08-25
...
*Of 265 systems and instruments on this place's ledger, 152 changed position between 2025-08-01 and 2026-08-25, 54 did not, 49 carry no stated baseline, and 9 are ***Not held*** at both ends.*

*Shape check, run before the comparison: 685 sources for this place in the window — 93 in the earlier half (2025-08 to 2026-01), 592 in the later (2026-02 to 2026-08). **The earlier half of the window is thin: this is a shorter comparison wearing a longer label**, and the movement below rests mostly on the later half.*
...
<!-- narrative: summary -->
Nearly four times as many sources sit in the later half of this window as in the earlier, so arrival counts measure coverage as much as construction.

No system climbed a maturity band, and every system that changed band went backwards. Satellite broadband regressed, its largest provider pausing new orders over congestion and then brought inside a biometric verification regime; the retail central bank digital currency is under review and being redesigned toward a wholesale model; and enforcement of the new internet-platform rules was paused pending a unified framework. One programme stalled — 260 state schools whose January 2026 completion date passed with many incomplete.

Everything else arrived or held. Nigeria's digital state was substantially built before the window opened.

The same year produced a data-localisation directive, a virtual-assets executive order, a crypto tax circular, an identity statute, an open-banking launch and a three-year payments vision.
<!-- /narrative -->
...
| Airtel Nxtra Eko Atlantic data centre | Did not exist | [Planned 38 MW GPU-ready build, over US$120m](https://developingtelecoms.com/telecom-technology/data-centres-networks/18888-airtel-nigeria-to-build-38mw-hyperscale-data-centre-in-eko-atlantic.html) | Advanced |
| Cassava National Sovereign Cloud | Did not exist | [In service](https://www.cassava.ai/2026/03/05/cassava-technologies-announces-national-sovereign-cloud-to-support-secure-digital-infrastructure-for-african-governments/) | Advanced |
| Digital Realty LKK2 Lagos data centre | Did not exist | [In service](https://www.datacenterdynamics.com/en/news/digital-realty-launches-a-2mw-data-center-in-nigeria/) | Advanced |
...
| National Sovereign Cloud Initiative | Did not exist | [Framework setting policy, technical and quality requirements for hosting government and business services in Nigeria, signed with the state-owned Galaxy Backbone; four instruments were signed on 4 August - a cloud computing guideline, a cloud technical guideline, a digital infrastructure assurance framework and a cloud investment strategy - with certification of cloud and artificial-intelligence infrastructure providers to begin in October 2026, oversight vested in a new governance committee and a stated ambition to serve West and Central Africa A Joint Technical Committee on the initiative was inaugurated in Abuja on 2026-08-21, chaired by the director-general of the Budget Office of the Federation with the information-technology development agency's director-general as co-chair, to align federal cloud expenditure, procurement and financing behind it; the agency put federal information-technology project submissions for 2023 to 2026 at over N4.2 trillion, of which about N3.89 trillion was identified and more than N400 billion saved through review.](https://von.gov.ng/nigeria-inaugurates-technical-committee-on-sovereign-cloud-initiative/) | Advanced |
...
| NASRDA direct-to-device satellite programme | Announced (2025-06) | [MoU with technology transfer and engineer training; no deployment](https://itweb.africa/article/nigeria-joins-race-to-deploy-direct-to-device-satellite-connectivity/5yONP7Erb3QMXWrb) | No change |
| NigComSat and Eutelsat LEO partnership | Announced (2025-01) | [Planned; no service](https://www.connectingafrica.com/connectivity/nigcomsat-eutelsat-partner-for-leo-services-in-nigeria) | No change |
...
| National Mortgage Registry | Did not exist | [Ready for deployment; no launch date, custodian or data-protection basis stated](https://fmino.gov.ng/housing-sector-stakeholders-converge-to-validate-national-housing-data-reform-policies/) | Advanced |
| Unique learner identification number | Did not exist | [A 16-digit Learner's Identification Number issued from April 2026, 1.9m at launch, integrated with the National Identification Number register through the Nigeria Education Management Information System across a stated 80m student records (2026-08)](https://nannews.ng/nigerias-digital-identity-gap-leaves-schoolchildren-behind/) | Advanced |
| National Electronic Assets Register | Live (2025-03) | [Live](https://www.thisdaylive.com/2025/03/07/uzoka-anite-national-electronic-assets-register-will-boost-nigerias-rating-with-creditors-unlock-investments-others) | No change |
| National Land Registration and Documentation Programme | In development (2025-03) | [More than 90% of land unregistered](https://www.thisdaylive.com/2025/03/20/with-300-billion-in-dead-capital-fg-plans-digitisation-of-land-information-system-nationwide) | No change |
...
| NIN verification of agricultural programme beneficiaries | Did not exist | [Planned, on a three-year subsidy taper](https://www.vanguardngr.com/2026/07/agric-ministry-adopts-nimc-identity-system-to-verify-genuine-farmers/) | Advanced |
| National social register | 19.7m households (2025-06) | [19.7m households, from 13m](https://www.biometricupdate.com/202506/nigeria-amplifies-efforts-to-id-prisoners-expand-social-register) | No change |
| Nigeria Digital Health Architecture | ***Baseline not held*** | [Health information, health services and health insurance claims exchanges named as the integration target](https://www.citizen.org/wp-content/uploads/2026-0009QN-Nigeria-Health-12.19.2025.pdf) | ***Baseline not held*** |
...
| ISO 20022 migration and PoS geo-tagging | Migration under way (2025-08) | [ISO 20022 with PoS geo-tagging](https://techafricanews.com/2025/08/27/cbn-requires-all-pos-machines-in-nigeria-to-be-geo-tagged-and-upgraded/) | Advanced |
| Nigeria Government Enterprise Architecture | Did not exist | [Hosted by Galaxy Backbone and piloted at four agencies](https://cioafrica.co/nitda-assumes-control-of-ngea-infrastructure/) | Advanced |
...
| First biometric population census | Planned (2025-03) | [Planned; the last census was 2006](https://www.thisdaylive.com/2025/03/08/nigerias-first-biometric-census) | No change |
...
<!-- narrative: dpi -->
Almost nothing in this section changed band.

The identity register held the same position throughout: implemented at the window's start and implemented now, with enrolment [rising from 123.9m to 136m](https://guardian.ng/news/nimc-enrols-136-million-nigerians-as-coker-odusote-pushes-stronger-inter-ministerial-partnership/) against a 180m target. What did enter the record is the statutory layer around it — the NIMC Act 2026, the root certification authority transfer, ICAO directory integration and the ward-level enrolment drive.

The national data exchange was announced in August 2025 and only began moving personal data in production in July 2026, behind the Government Service Portal; the lawful basis for that operation is not on record at either end.

The payments instruments issued in the window were [open banking](https://techcabal.com/2025/04/29/cbn-launches-open-banking/), a national payment stack, automated anti-money-laundering standards, market-concentration caps and the [localisation directive](https://complyan.com/nigerias-cbn-data-localisation-directive-what-banks-and-fintechs-must-do-before-2027/) among them. The rails they govern held their positions throughout.

The one regression is the retail central bank digital currency, Africa's first, now under review and being redesigned toward a wholesale model with the Bank stating it is not abandoned.
<!-- /narrative -->
...
| Nigeria-Benin-Cameroon customs border modernisation (Trilateral Strategic Steering Committee) | Did not exist | [Committee committed to digital interoperability, harmonised procedures and coordinated risk management at the Seme-Krake and Mfum-Ekok corridors; no funding, timeline or output published](https://theinsight.com.ng/nigeria-customs-benin-cameroon-deepen-regional-border-modernisation-at-beitbridge-benchmarking-mission/) | Advanced |
| Global CBPR Forum membership | Member (2025-04) | [Member](https://www.vanguardngr.com/2025/04/nigeria-joins-global-cross-border-privacy-forum/) | No change |
...
| America First Global Health Strategy MOU | Did not exist | [Signed 2025-12-19; US$1,953,530,560 planned United States support against Nigeria's US$2,975,634,499. A rights organisation's reading of the seven signed memoranda puts Nigeria among five whose text requires unilateral sharing of specimens and pathogen-sequencing data, and among two whose data-sharing arrangement is deferred to an unpublished Appendix 5, with all seven requiring broad audit access](https://www.hrw.org/news/2026/06/08/human-rights-assessment-of-the-2025-2026-us-bilateral-health-agreements) | Advanced |
| Civil-society enforcement against a public body | Did not exist | [A Federal High Court suit against the electoral commission](https://fij.ng/article/fij-showed-that-inec-broke-data-law-digital-rights-lawyers-sue-the-commission-10-months-later/) | Advanced |
| Federal Government circular on MDA data-protection compliance | Did not exist | [Announced by the data-protection commission as Circular No. 59805/S.I/74 of 27 July 2026 directing service-wide compliance, but the document itself is not in the public record: searches of the Secretary to the Government of the Federation's own resource portal by number, keyword and date returned nothing three days after the announcement](https://fij.ng/article/ndpc-claimed-fg-ordered-mdas-to-obey-data-protection-law-nigerians-search-but-cant-find-order/) | Advanced |
| Meta-funded data-protection capacity programme | Did not exist | [A two-year programme funded under a court-approved settlement](https://itweb.africa/article/meta-backs-ndpc-in-landmark-privacy-initiative/lwrKxq3Y2W27mg1o) | Advanced |
| NDPC and NCC data-protection MoU | Did not exist | [Cooperation between the two regulators](https://www.thisdaylive.com/2026/02/06/ncc-ndpc-sign-mou-to-enhance-data-protection-in-telecoms-sector/) | Advanced |
| NDPC enforcement regime | Compliance about 55% (2025-03) | [Remediation-first enforcement, compliance above 55%; on 2026-08-13 the commission opened a forensic investigation into a federal university, a bank and a technology vendor over the alleged use of students’ personal data to open bank accounts without consent](https://techafricanews.com/2025/08/25/nigeria-probes-1369-organizations-in-major-data-privacy-crackdown/) | Advanced |
| NDPC investigations of multinational platforms | Did not exist | [Multinational platforms under investigation](https://itweb.africa/article/nigeria-probes-tiktok-truecaller-on-suspected-data-breaches/o1Jr5qxPz3yqKdWL) | Advanced |
...
| Nigeria Data Protection Act 2023 | In force (2023) | [In force; the Commission sits under ministerial control, and implementation at state level is being pressed rather than achieved](https://thesun.ng/fg-ngf-to-states-implement-data-protection-act-or-risk-trust-investment/) | No change |
...
| Election digital-rights monitoring platform | ***Baseline not held*** | [A civil-society platform tracking political parties' websites and social media for data-privacy violations and access restrictions during elections, piloted at a state governorship election](https://www.nationalrecord.com.ng/citad-launches-pawsom-monitor-to-track-digital-rights-breaches-ahead-of-2027-elections/) | ***Baseline not held*** |

<!-- narrative: governance -->
One position worsened and the rest of the section arrived.

Internet-platform regulation regressed: enforcement of new rules was paused in July pending a unified national digital-economy policy framework. The same month's competition directive put the same class of company under investigation for abuse of dominance.

Data-protection enforcement held its band and changed character within it: already active at the window's start, having lifted compliance from about 4% [to 55%+](https://techafricanews.com/2025/08/25/nigeria-probes-1369-organizations-in-major-data-privacy-crackdown/) by March 2025, what the year added was judicial confirmation. The Federal High Court upheld the Commission's registration power in July, and days later a private claimant won the first damages award under the Act without needing the Commission at all. Neither judgment is held, and one has no established delivery date.

What arrived: an executive order that creates a coordination council rather than a regulator, and a tax framework that collects duty in the token. The two rows that held position throughout are the statute itself and the 2021 draft data and cloud policy — five years a draft, while the localisation question it was written to answer was settled instead by a central bank circular.
<!-- /narrative -->
...
| Airtel AI spam detection | Live (2025-03) | [Live](https://itweb.africa/article/airtel-nigeria-launches-ai-spam-alert-service/wbrpO7g2oapvDLZn) | No change |
| State dividend from the mobile incumbent | ***Baseline not held*** | [About US$41m due to the state from a US$406m operator dividend payout (2026-08)](https://techcabal.com/2026/08/19/nigeria-to-earn-41-million-from-mtns-406-million-dividend-payout/) | ***Baseline not held*** |
...
| NCC Digital Industrial Park and Learning Centre lease to Enugu State | Did not exist | [Two federal facilities transferred to state operation for 15 years, to run as the Enugu Talent City and an AI institute](https://www.thisdaylive.com/2026/08/04/ncc-leases-digital-industrial-park-learning-centre-to-enugu/) | Advanced |
| Itana digital free zone | Live (2025-06) | [Remote incorporation on a US$100m phase-1 commitment](https://techcabal.com/2025/06/10/inside-itana-nigerias-first-digital-free-zone/) | No change |
| JICA startup hub programme | Running (2025-06) | [US$11.2m startup hub plus US$40m for social-startup support](https://techafricanews.com/2025/06/19/nigeria-signs-agreement-with-japanese-consortium-for-51-2-million-startup-hub-project/) | No change |
| Moove drive-to-own vehicle financing | ***Baseline not held*** | [A 42,000-vehicle ride-hailing fleet across 14 countries financed against platform earnings, at a US$2.1bn valuation (2026-08)](https://techcrunch.com/2026/08/05/moove-raises-250m-to-become-the-backbone-of-the-robotaxi-industry/) | ***Baseline not held*** |

### US / hyperscaler activities

| System or instrument | At 2025-08-01 | At 2026-08-25 | Movement |
|---|---|---|---|
| Google AI alliance, research and skilling | Alliance signed (2025-02) | [A five-area alliance, ₦3bn across five partners, and a second consecutive year of free student AI subscriptions](https://techcabal.com/2026/08/20/google-is-giving-nigerian-students-a-year-of-free-ai-access/) | Advanced |
...
| Talent-export platform partnership | Running (2025-04) | [Running](https://www.wearetech.africa/en/fils-uk/news/public-management/nitda-partners-with-doballi-to-boost-employment-for-nigerian-tech-talents) | No change |
...
| Anambra SmartGov | Live (2025-06) | [Flagged ₦2.1bn unspent and detected ghost workers](https://techcabal.com/2025/06/30/anambra-builds-ai-model/) | No change |
| Lagos Ask INU survivor-support chatbot | Live (2025-02) | [Live](https://www.wearetech.africa/en/fils-uk/news/tech/nigeria-launches-ai-chatbot-and-self-reporting-portal-for-domestic-violence-survivors) | No change |
...
<!-- narrative: ai-tech -->
No system in this section changed band, and the governing instrument is still inside a bill.

What arrived: the sovereign multilingual model in September 2025; the risk-based regime's public timeline in January 2026; a proposed governance framework for public-sector AI in June, which asks first for an inventory of what is already running; the central bank's Responsible AI in Finance Hub, proposed over an [installed base of 87.5% of surveyed fintechs](https://bitcoinke.io/wp-content/uploads/2026/02/Shaping-the-Future-of-Fintech-in-Nigeria-Central-Bank-of-Nigeria-2025-Fintech-Report-BitKE.pdf) already using AI for fraud detection.
...
| Enugu Talent City and AI Institute | Did not exist | [The communications regulator leased its Enugu Digital Industrial Park and Learning Centre to the state government for fifteen years, to be run as a talent city and artificial-intelligence institute for digital skills, startup incubation, outsourcing, research and technology businesses](https://techafricanews.com/2026/08/18/ncc-leases-digital-industrial-park-to-enugu-government-for-15-years/) | Advanced |
...
| Lagos teacher AI literacy programme | Did not exist | [Entering the classroom through teachers rather than the curriculum](https://techcabal.com/2026/07/18/ness-2026-charts-new-course-for-leading-funding-and-equipping-nigerian-schools/) | Advanced |
| Mastercard Foundation EdTech Fellowship | Running since its 2019 launch | [Twelve startups in cohort 4; 72 companies supported since 2019](https://techcabal.com/2026/08/04/cchub-mastercard-foundation-select-12-startups-for-fourth-edtech-fellowship-cohort/) | Advanced, fourth cohort |
| NBTE National Diploma curriculum in AI for polytechnics | Did not exist | [National Diploma curriculum in artificial intelligence launched for Nigerian polytechnics; NBTE reports AI has cut its own curriculum-development costs by about 50% by generating draft curricula and courseware](https://nitda.gov.ng/nitda-commends-nbtes-ai-curriculum-calls-for-broader-integration-of-emerging-technologies-in-technical-education/9679/) | Advanced |
| Startup Abuja student aid programme | Did not exist | [A 50-million-naira programme, about US$37,000, offering higher-education students tuition support, a monthly stipend and paid remote internships, with applications closing on 31 August 2026](https://www.wearetech.africa/fr/fils/breves/breves-une/startup-abuja-lance-un-programme-de-50-millions-de-nairas-pour-les-etudiants) | Advanced |
| Three-million technology talent programme | Running (2025) | [1.87m registrations across all 774 LGAs, more than 135,000 trained across three cohorts and 15,000 job pathways created (2026-08), against a target of ICT at 22% of GDP by 2027](https://www.wearetech.africa/en/fils-uk/news/public-management/nigeria-plans-10bln-tech-hub-in-katsina-to-anchor-national-digital-push) | Advanced |
| Data-protection officer certification pipeline | Running (2025-05) | [Aimed at an informal sector that is 65% of employment](https://itweb.africa/article/mastercard-ndpc-target-data-protection-in-nigerias-informal-sector/RgeVDqPRa8Y7KJN3) | No change |
...
Four absences stand dated, and three of them converge on 2027-01-01. No hyperscaler cloud region or local availability zone has been announced; no government instrument sequences grid capacity against the localisation deadline; and whether a foreign cloud's in-country zone satisfies the directive is the question the circular does not answer. The fourth is the absence of any published register of notified data breaches.
<!-- /narrative -->
