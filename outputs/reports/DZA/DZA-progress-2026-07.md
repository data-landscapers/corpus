...
*Of 101 systems and instruments on this place's ledger, 70 changed position between 2025-08-01 and 2026-08-04, 16 did not, 7 carry no stated baseline, and 7 are ***Not held*** at both ends. A further 1 took a position dated after 2026-08-04 and are carried in the status report rather than compared here.*

*Shape check, run before the comparison: 171 sources for this place in the window — 54 in the earlier half (2025-08 to 2026-01), 117 in the later (2026-02 to 2026-08). The two halves are comparable, so the comparison is made over the whole window.*
