...
*Of 122 systems and instruments on this place's ledger, 75 changed position between 2025-08-01 and 2026-08-26, 19 did not, 21 carry no stated baseline, and 7 are ***Not held*** at both ends.*

*Shape check, run before the comparison: 254 sources for this place in the window — 50 in the earlier half (2025-08 to 2026-01), 204 in the later (2026-02 to 2026-08). **The earlier half of the window is thin: this is a shorter comparison wearing a longer label**, and the movement below rests mostly on the later half.*
...
<!-- narrative: summary -->
Twelve months ago Angola had no cybersecurity strategy, no cybersecurity council, no cybersecurity centre, no bill in parliament, no operating government data centre or cloud, and no connection to the newest subsea system. All of those now exist. The decree track did that work; the statutory track has not moved past proposal in nineteen months of parliamentary time, so the country still has no operator obligation, no incident-notification duty and no critical-infrastructure designation — a gap the July mobile outage tested directly.
<!-- /narrative -->
...
| False information law (Lei n.º 6/26) | Did not exist | [A false-information regime in force from 4 August 2026, binding telecom operators, digital platforms and application providers, reaching content aimed at the domestic public from outside the country, and banning inauthentic accounts. On 22 August 2026 the journalists' union, the professional credential and ethics commission and the women journalists' forum warned that the law will inhibit citizen journalism, arguing that its penalties are excessive and that whether something counts as a journalistic error will depend heavily on how the courts and the aggrieved party read it](https://www.novojornal.co.ao/politica/detalhe/jornalistas-advertem-que-lei-vai-inibir-jornalismo-de-cidadania-erro-jornalistico-dependera-da-interpretacao-dos-tribunais-e-do-lesado-74134.html) | Advanced |
...
| Export of national satellite capacity to neighbouring states | Did not exist | [Mozambique's state operator has begun proof-of-concept testing of the Angolan satellite for providing telecommunications services in Mozambique, announced by the Angolan telecommunications ministry as a step towards a commercial agreement to distribute communication and broadcasting signals over Angolan space infrastructure; it follows the Mozambican public broadcaster's own proof of concept transmitting its television signal via the satellite and implements a bilateral memorandum signed in June 2026, and runs in parallel with a commercial pilot agreement with a Namibian operator for satellite-driven backhaul](https://www.itweb.africa/article/tmcel-begins-angosat-2-satellite-trials/JN1gPvOAwolMjL6m) | Advanced |
...
The executive legislated and Parliament did not. Three decrees took effect in December 2025 — a national cybersecurity strategy, a council and a centre with regulatory, supervisory, inspection and sanctioning powers — where a year earlier there was no cybersecurity instrument at all. That is the band change.

The parliamentary band did not move. Not one of the five bills in this ledger is established as promulgated. The cybersecurity bill has spent the window between a heavily abstained general approval and a technical redraft that its own rapporteur says preserves the substance those abstentions were about. The online falsehoods law passed definitively in May 2026 and has no promulgation, gazette number or enforcement action on file. The startups law passed in March 2026 and has no gazette citation. The digital government bill closed consultation at end-May 2026 and has not been tabled.

The data-protection authority's own change is accretion on a position it already held: bigger fines and a first bilateral with a non-African regulator, but the same statute, the same undated deliberations and the same unpublished caseload. Two objects resolved: an amendment that would have opened electoral data was rejected in plenary in June 2026, and the satellite licensing process stalled — two years in, with a final phase claimed in June 2026 and nothing issued by August.
<!-- /narrative -->
...
| Supplementary credit for the citizen-database update | Did not exist | [US$275,000,000 opened inside the 2026 budget, more than doubling the territorial administration ministry's allocation, for the adult-citizen database proof-of-life update](https://www.novojornal.co.ao/economia/detalhe/pr-manda-abrir-credito-adicional-suplementar-de-275-milhoes-usd-no-oge2026-para-o-mat-e-duplica-dotacao-do-ministerio-70083.html) | Advanced |
...
Three positions changed band. The international layer moved: a subsea branch entered service in December 2025 allocating 23.6 Tbps to the country, and a service agreement in June 2026 contracted an initial 1.0 Tbps of another cable's capacity through a neighbouring landing. Storage moved: a commercial Tier III facility opened in October 2025, and the government data centre and national cloud were inaugurated in April 2026. And the executive cybersecurity architecture was created outright, with three presidential decrees taking effect in December 2025.
...
| Single digital identity | Named as a workstream in the 2024 World Bank loan agreement, nothing built | [Procurement opened: the President authorised US$28m for a National Digital Identity and Electronic Signatures Platform and formally opened the public tender by Despacho Presidencial 300/26 of 13 August 2026. The platform is specified to support up to 30 million digital identities and to let citizens, firms and public officials use a single digital credential for public services, digital contracts, electronic identity verification of customers and legally valid electronic signatures](https://pti.ao/pr-aprova-usd-28-milhoes-para-aquisicao-de-plataforma-de-identidade-digital-e-assinaturas-electronicas/) | Advanced |
...
| National biometric border-control system | Baseline not held | [Budgeted at US$112m and awarded in February 2025 to Dolinveste Lda with Poland’s Technology for Business, reportedly by direct award rather than open tender; no biometric system operates at the border posts with the Democratic Republic of the Congo, and the one functional post, Santa Clara on the Namibian border, reads passports against the migration service database but has discontinued fingerprint and height capture on maintenance grounds](https://executivedigest.sapo.pt/servicos-de-informacoes-angolanos-acedem-a-dados-biometricos-sem-controlo-judicial-relatorio/) | ***Baseline not held*** |
...
| Incubation programme | An incubation programme with institutional and technical support, physical space, training and investor introductions | [Unchanged; no cohort, intake number, graduate or funding outcome published in seventeen months](https://www.wearetech.africa/en/fils-uk/news/tech/angolan-agencies-join-forces-to-strengthen-nascent-startup-sector) | No change |
| Startup population and funding penetration | About 125 startups, with no exit event yet | [Unchanged; fewer than 2% of identified startups have secured venture funding, with angel and seed structures largely absent](https://itweb.africa/article/angola-passes-landmark-start-up-law/lLn14MmQwnVMJ6Aa) | No change |
| Only mobility startup with named investors | ***Baseline not held*** | [The country's only entrant in a fifteen-startup cohort drawn from about 2,600 applications, with AI-powered credit scoring to formalise motorcycle-taxi work and US$4.6m raised across named investors](https://blog.google/intl/en-africa/company-news/meet-the-15-startups/) | ***Baseline not held*** |
...
| Identity-card universalisation plan | Card printing centralised at a single national production centre | [Printing posts in all 21 provincial capitals, two to three printers per province planned, mobile brigades in remote municipalities, and three phases covering unregistered adults, cards at birth and replacement of degraded documents; a provincial campaign issued and delivered more than 4,000 cards in 16 days in a single municipality](https://minjusdh.gov.ao/web/noticias/programa-de-universalizacao-do-bi-reforca-acesso-a-documentacao-em-egito-praia) | Advanced |
| National financial inclusion strategy | Did not exist | [Financial inclusion at 51.7% in the first quarter of 2026 against a 65% target for 2027, with the next phase to let mobile and digital payment providers extend credit](https://angop.ao/noticias/economia/governo-anuncia-nova-etapa-na-estrategia-nacional-de-inclusao-financeira/) | Advanced |
...
| Satellite connectivity programme | ***Baseline not held*** | [Six universities and more than 300 localities where mobile operators are absent, with 20,000 students stated, against 27 locations and about 366,000 citizens stated to a UN body in November 2025](https://angop.ao/noticias/economia/vinte-mil-estudantes-beneficiam-do-projecto-conecta-angola/) | ***Baseline not held*** |
...
| Transport corridor fibre link | ***Baseline not held*** | [A domestic submarine cable to interlink the main coastal cities, with the transport corridor connected to international systems; no route, cost, contractor, financier or completion date stated](https://angop.ao/noticias/sociedade/minttics-implementa-projectos-estruturantes-para-a-redefinicao-da-base-tecnologica-do-pais/) | ***Baseline not held*** |
...
<!-- narrative: gaps -->
The absences below did not close during the period. Every one of the eleven digital budget lines the wiki holds still carries an empty actual and audited column, so no execution figure exists for any programme in any year beyond the single quarterly reading; and the operative texts of five bills and laws remain unheld. They are the first briefs for the country-deep sweep.
<!-- /narrative -->
