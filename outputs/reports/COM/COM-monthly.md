...
<!-- narrative: summary -->
Twenty-three rows moved, and the month divides into three kinds of thing. One failure: the mobile-money interface to prepaid electricity meters [let meter credit go uncollected on Mwali](https://www.comoresinfos.net/200-millions-de-francs-de-pertes-presumees-que-sest-il-passe-entre-mvola-et-la-sonelec-a-moheli/), the only regression on the ledger, on an island whose thermal plant was the same month [running on a seventh of the diesel it needs](https://alwatwan.net/societe/p%C3%A9nurie-de-carburant-%C3%A0-mwali-i-l%E2%80%99%C3%A9lectricit%C3%A9-de-nouveau-rationn%C3%A9e.html).
