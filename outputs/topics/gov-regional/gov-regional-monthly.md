...
The second meeting of the Africa Public Key Infrastructure Forum, held in Abuja, [called for harmonised African rules so that digital credentials, electronic signatures and documents can be verified across borders](https://ait.live/africa-moves-to-harmonise-digital-trust-rules-across-borders/). Nothing was adopted, and the repository holds no instrument, timetable or signatory list behind the call.
