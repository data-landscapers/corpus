...
<!-- narrative: summary -->
Niger has legislated most of an identity stack into being in a single burst. Four instruments of April and May 2026 [created a civil-status regime, three interoperable registers and a new agency to run the population register](https://www.lesahel.org/wuri-niger-restructure-une-opportunite-pour-une-identification-universelle-de-la-population-au-service-de-linclusion-et-du-un-puissant-facteur-de-developpement-inclusif-et-une-dimension/); [mass enrolment for the AES biometric national identity card began on 25 April 2026](https://www.lesahel.org/carte-nationale-didentite-biometrique-aes-lancement-de-lenrolement-de-masse-sous-le-signe-de-la-souverainete-numerique/) and [passport enrolment on 16 July 2026](https://www.actuniger.com/politique/22202-passeport-biometrique-aes-le-president-de-la-republique-donne-le-coup-denvoi-de-la-phase-denrolement-du-nouveau-document-de-voyage.html). No gazetted text of the four instruments is held.

The base underneath is thinner than the stack above it: [66% of births are declared nationally](https://www.lesahel.org/wuri-niger-restructure-une-opportunite-pour-une-identification-universelle-de-la-population-au-service-de-linclusion-et-du-un-puissant-facteur-de-developpement-inclusif-et-une-dimension/), and the ITU put internet penetration at 23.2% at the end of 2025.

Physical infrastructure arrived late in 2025 — [1,031 km of Trans-Sahara fibre and a Tier III data centre provisionally accepted in November](https://www.lesahel.org/projet-de-la-dorsale-transsaharienne-a-fibre-optique-un-levier-essentiel-pour-le-desenclavement-numerique-du-niger/), against a delivery date of 30 September 2025 — while the [cyber institutions blueprinted in July 2025](https://www.lesahel.org/installation-dun-comite-national-charge-de-loperationnalisation-et-du-deploiement-des-infrastructures-numeriques-critiques-poser-les-bases-de-la-resilience-et-la-securite-des/) have not moved since.
...
| Telco-integrated satellite service | [Implemented](https://www.actuniger.com/societe/21684-connectivite-et-innovation-airtel-niger-lance-sa-solution-starlink-by-airtel-pour-plus-dinternet-aux-usagers.html) | Commercialised by Airtel Niger 2026-01-18 |
| Trans-Sahara fibre backbone | [Implemented](https://www.lesahel.org/projet-de-la-dorsale-transsaharienne-a-fibre-optique-un-levier-essentiel-pour-le-desenclavement-numerique-du-niger/) | Provisional acceptance of 1,031 km on five cross-border axes, 2025-11-14 |
...
Satellite is the access story. [Starlink has been commercially available since 13 March 2025](https://www.actuniger.com/technologie/20854-starlink-enfin-disponible-officiellement-au-niger-lespoir-dune-connexion-fiable-et-rapide-devient-realite.html) under an agreement signed with SpaceX in October 2024, and in [January 2026 Airtel Niger commercialised a telco-integrated version](https://www.actuniger.com/societe/21684-connectivite-et-innovation-airtel-niger-lance-sa-solution-starlink-by-airtel-pour-plus-dinternet-aux-usagers.html) in which the operator rather than the customer holds the satellite relationship.
...
| National Population Register | [In development](https://www.lesahel.org/wuri-niger-restructure-une-opportunite-pour-une-identification-universelle-de-la-population-au-service-de-linclusion-et-du-un-puissant-facteur-de-developpement-inclusif-et-une-dimension/) | Enrolment starting in Niamey's five arrondissements |
...
That stack is three registers and an agency. A National Civil Register and a National Nationality Register were instituted by ordonnance of 22 April 2026; a National Population Register is being built as the single authentication point for services conditioned on identification; and [ANEI was created and chartered by two décrets of the same date](https://www.lesahel.org/wuri-niger-restructure-une-opportunite-pour-une-identification-universelle-de-la-population-au-service-de-linclusion-et-du-un-puissant-facteur-de-developpement-inclusif-et-une-dimension/) with no budget, staffing or enrolment target stated. Population-register enrolment starts in Niamey's five arrondissements.

Civil registration is the constraint the design assumes away. Nationally 66% of births are declared. One region publishes a number: Diffa reports [173,109 birth certificates issued between July 2023 and July 2026 and timely declaration up from 56% in 2022 to 88.04% in 2025](https://anp.ne/mise-en-oeuvre-du-programme-de-la-refondation-a-diffa-plus-de-173-000-actes-de-naissance-delivres-entre-juillet-2023-et-juillet-2026/), on village chiefs trained as mobilisers and four computerised communes.

The administrative systems are payroll-first. The [integrated state human resources and payroll system has 16,500 agent files digitised and 23,000 updated against a scope of about 200,000 public agents](https://www.lesahel.org/conseil-consultatif-de-la-refondation-la-ministre-aissatou-abdoulaye-tondi-explique-aux-conseillers-le-sigrhep/), replacing systems the responsible minister describes as ageing and unintegrated; [student grants are to be routed through the Treasury's own application](https://anp.ne/niger-plusieurs-reformes-engagees-pour-ameliorer-le-secteur-de-lenseignement-superieur-et-les-performances-de-lanab/), stated as an intention rather than a live service. Health has a [validated master plan with 27 structuring projects](https://www.lesahel.org/atelier-de-la-direction-de-la-e-sante-vers-une-transformation-numerique-du-systeme-de-sante/) and the [tax administration is rebuilding after sanctions](https://www.lesahel.org/digitalisation-de-ladministration-fiscale-nigerienne-la-dgi-reunit-les-acteurs-pour-batir-une-trajectoire-de-modernisation-maitrisee-et-progressive/).

Payments are thin and interoperating. [Bank-to-wallet transfers went live in June 2026](https://www.lesahel.org/communique-de-presse-niger-banque-atlantique-et-nita-renforcent-linteroperabilite-entre-services-bancaires-et-paiement-mobile/); the same operator runs the [kiosks that take the identity-card fee](https://www.actuniger.com/societe/21937-carte-nationale-didentite-biometrique-cnib-avec-nita-les-demarches-simplifiees-pour-regler-ses-frais-et-se-faire-enroler-en-toute-serenite.html). Niger holds [3.92% of electronic-money accounts opened across the eight-state Union](https://www.bceao.int/sites/default/files/2026-03/Rapport%20annuel%20sur%20les%20services%20financiers%20num%C3%A9riques%20dans%20l%27UEMOA%20-%202024.pdf).
...
<!-- narrative: gaps -->
Four rows carry no reliable statement of status. One is now a dated, searched absence: ARCEP's 2021 annual report names the decision behind the quality-of-service thresholds every enforcement action cites, but not the values themselves. Two are unpublished figures for systems that exist — the capacity of the Niamey data centre, and power provision for network sites and the data centre. The remaining absence is a whole subject the base holds nothing on: any budget appropriation for digital government.
<!-- /narrative -->
