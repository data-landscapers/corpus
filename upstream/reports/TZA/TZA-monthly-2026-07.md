...
The state operator [gave students of a technical institute hands-on training on backbone technologies](https://techafricanews.com/2026/07/23/ttcl-equips-dit-students-with-practical-broadband-infrastructure-skills/), reported 23 July with no intake number or cadence; and a data-centre group named its Tanzanian site as under development while raising [committed capital from US$350m to US$380m](https://tech.africa/raxio-380m-committed-capital/), giving no Tanzanian size, cost or date.
<!-- /narrative -->
...
At an agricultural exhibition on 4 August the e-government agency stated that [more than 6,000 cooperative societies are registered](https://dailynews.co.tz/ega-drives-digital-farming/) on its management system, and described a farmer-records and permits system and a fertiliser monitoring system. No user counts, spend or timeline were given.
<!-- /narrative -->
