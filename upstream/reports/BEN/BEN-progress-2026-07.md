---
title: Benin — progress report, 2025-08-01 to 2026-08-04
compiled: 2026-08-04
...
# Benin: progress report, 2025-08-01 to 2026-08-04
...
*Of 83 systems and instruments on this place's ledger, 52 changed position between 2025-08-01 and 2026-08-04, 13 did not, 14 carry no stated baseline, and 4 are ***Not held*** at both ends.*

*Shape check, run before the comparison: 159 sources for this place in the window — 41 in the earlier half (2025-08 to 2026-01), 118 in the later (2026-02 to 2026-07). The two halves are comparable, so the comparison is made over the whole window.*
...
<!-- narrative: summary -->
The shape check above passes at full width, so what follows compares the whole twelve months rather than a shorter period wearing a longer label.

Not one existing system climbed a maturity band — nothing went from planned to piloting or piloting to implemented — and nothing stalled except the e-procurement rebuild, whose first tender failed. What the movement table records is rules and reach appearing on top of a stack that was already there.

Benin's foundational layers were all in place and operating when the window opened, and there was no lower band for them to leave. What the year added was rules, reach and disclosure on top of a stack that was already built.
...
[Birth registration entered the record as a problem](https://www.lanation.bj/actualites/aristide-adjinacou-directeur-general-de-lanip-nous-voulons-faire-de-chaque-maternite-une-veritable-porte-dentree-vers-lidentite-legale) — about 2.5m births declared against under 1m registered — with a pilot fix at 76.56% whose generalisation slipped. And the e-procurement platform entered as a decree retiring the old system followed by a failed tender.
...
<!-- narrative: gaps -->
Five subjects carry no reliable position at either end, all probed once on 2026-08-04, and two returned a route.

The decree instituting the national data exchange is served as a PDF from the operator's own media host, which an earlier attempt on the government secretariat and a ministry site did not reach. Until it lands, everything stated here about the exchange's legal basis rests on a framework document that cites the decree without reproducing it. The second is the budget directorate's published execution reports, the only published route to executed figures.

Three absences stand dated: no Cour des comptes execution report after 2023, no Benin–India digital instrument in India's own list of twenty-four partner states, and nothing establishing the government AI super app.
<!-- /narrative -->
