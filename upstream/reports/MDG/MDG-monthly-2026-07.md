...
<!-- narrative: summary -->
The first phase of biometric enrolment closed with [more than six million adults registered against a two-million target](https://www.lexpress.mg/2026/07/recensement-lidentite-biometrique.html), and the day after that was reported the electoral commission [opened a full reconstitution of the electoral roll, gated on presentation of a national identity card](https://2424.mg/election-la-ceni-lance-les-operations-de-recensement-pour-la-refonte-de-la-liste-electorale-avant-les-scrutins-de-2027/).

The Council of Ministers of 8 July did two things on the same day: it [adopted a bill overhauling the 2014 cyber law](https://www.agenceecofin.com/actualites-numerique/0907-140040-madagascar-adopte-un-projet-de-loi-pour-moderniser-son-arsenal-contre-la-cybercriminalite) and it [ordered internet service providers to block pornographic sites, with no timetable, mechanism, named regulator or appeal route](https://www.wearetech.africa/fr/fils/actualites/madagascar-annonce-le-blocage-des-sites-diffusant-des-contenus-obscenes).

The national police [opened a public reporting platform for violence and disappearances on 28 July](https://midi-madagasikara.mg/police-nationale-une-plateforme-numerique-pour-signaler-les-violences-et-les-disparitions/) with no data controller, retention rule or supervisory authority named, and MVola's new director general [gave the first account of the platform migration that broke the country's dominant payment rail](https://www.lexpress.mg/2026/08/alexandre-castel-directeur-general-de.html).
<!-- /narrative -->
