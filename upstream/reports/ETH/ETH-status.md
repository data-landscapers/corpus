...
*Compiled 2026-08-06 from the Data Landscapers source base, from `outputs/reports/ETH/ledger.csv` (77 systems and instruments, 4 of them ***Not held***). Each section opens with its ledger; specific events are covered in the monthly updates. Figures are dated because most are time-varying.*
...
| Network expansion contracts from MWC 2026 | [Implemented](https://addisstandard.com/ethio-telecom-announces-strategic-network-expansion-agreements-with-ericsson-zte-huawei-nokia-at-barcelona/) | Signed at MWC, 2026-03-09 |
...
| M-PESA Ethiopia | [Implemented](https://itweb.africa/article/m-pesa-ethiopia-surges-258-as-ethswitch-fuels-growth/) | 12.2m active customers (2026-06) |
...
<!-- narrative: dpi -->
[Faydaverse was inaugurated on 2026-08-04 as a state-owned enterprise under Ethiopian Investment Holdings](https://www.biometricupdate.com/202608/faydaverse-officially-enters-africas-dpi-market), mandated to develop, operate and scale digital public infrastructure, with the National ID Program's executive director since 2021 as chief executive; the holding company states the purpose as attracting partnerships and creating long-term value. The programme reports over 190m authentications performed and 150 enterprises integrated for biometric checks, on its own figures.

Ethio Telecom alone accounts for [69% of all registrations](https://www.ena.et/web/eng/w/eng_9268046) — about 32m citizens since April 2024 — through a commercial franchise network. The custody and consent terms of that architecture are not stated in any account held.

[Every bank account](https://www.nbe.gov.et/fayda-banking-integration) was to be harmonised with the identity by 2026-03-30, school enrolment and examinations carry a mandate, and the credential is integrated with tax administration.

MESOB's own executives describe it as a front door onto unreformed back offices, and a national data exchange platform is only now approved. The Auditor General [credited the federal e-procurement system](https://www.ofag.gov.et/ofag/the-office-of-the-federal-auditor-general-presents-its-annual-audit-report-to-the-house-of-peoples-representatives/) with a decline in cash shortages, while the same report found budget-execution gaps, billions of Birr uncollected and repeated financial-rule violations across the 163 institutions audited.

Below the federal tier the base holds little: the Addis Ababa city administration [reports 11 one-stop centres carrying more than 150 services](https://www.amn.gov.et/en/addis-ababas-digital-one-stop-platform-streamlines-government-services-bringing-over-150-services-under-one-digital-system-official/) at fiscal-year close, with no volumes, cost or evaluation published — its own account, through its own outlet.

Telebirr moves about 11bn Birr a day across 60.6m users, and [M-PESA passed 12.2m active customers](https://itweb.africa/article/m-pesa-ethiopia-surges-258-as-ethswitch-fuels-growth/) after the October 2025 switch integration linked it to more than 30 banks and wallets.
<!-- /narrative -->
...
| Digital public infrastructure export to Mozambique | [Implemented](https://www.biometricupdate.com/202604/mozambique-taps-ethiopias-digital-id-expertise-in-dpi-partnership) | Three-year memorandum 2026-04-28 |
...
Proclamation 1321/2024 entered into force on 24 July 2024 and designates the Ethiopian Communications Authority as regulator. A year on, the secondary directives were unissued, public awareness was low and the Authority had yet to enforce — while the identity system it would supervise authenticates about 4m times a day. The budget documents make the same point fiscally: the country appropriates nothing separately identifiable for enforcing the law it passed.

Two July instruments moved. The central bank [widened its prohibition on virtual assets](https://www.thereporterethiopia.com/51969/) to the whole category by clarification rather than by new rule, with no enforcement mechanism announced. And the payment-gateway sector is being [taxed on an arithmetic error the central bank has admitted](https://www.thereporterethiopia.com/52044/): gross transaction volume was conflated with gateway revenue in data compiled for a revenue audit. Corrected datasets issued in April 2026 were not accepted, and ETB 818m was swept from frozen accounts in May against a liability counsel puts at ETB 20–30m.

The correction came from a court. In June 2026 the Federal High Court of Lideta struck down a decree cutting banking services to betting platforms and gateways, finding licence revocation without a court order unconstitutional and noting that suspicion does not constitute guilt.

Platform liability is being drafted for the first time. The Intellectual Property Authority said on 2026-08-01 that amendments to Copyright and Neighboring Rights Protection Proclamation 410/2004, prepared with the Addis Ababa University School of Law, [would define internet service provider duties, set procedures for blocking infringing sites and add a rights-holder take-down notice](https://www.thereporterethiopia.com/52113/); no draft text, introduction date or timetable is published. A draft proclamation ratifying the Berne Convention was before the Council of Ministers on the same date, Ethiopia not yet being a party.
<!-- /narrative -->
