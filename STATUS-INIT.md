...
**Four of the last fourteen were written while their evidence was still in the hand-carry queue.** NER, MRT, STP and MLI had 581 files sitting in `C:\corpus-osint-xfer\new-queue\` uningested on the day they were run, and they are the four thinnest units in the checklist — the same fact seen twice. What draining a queue is worth was measured the same day: GNQ's was drained that morning and its catalogued record count went from 101 to 222, roughly doubling the evidence its baseline was written from. **These four are the first candidates for a re-baseline once their queues are through**, and nothing else in the 54 is known to be short of held evidence.
