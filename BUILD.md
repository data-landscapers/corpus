...
- **No acquire line is ever written here.** `osint-corpus-exchange/africa-acquire.csv` reports 2024-or-later material found during initialisation that the daily sweep should have caught and did not. A source reaching BUILD has by definition been caught, so nothing is owed, whatever its date.
